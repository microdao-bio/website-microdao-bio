...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [8595],
  {
    76540: (e, n, o) => {
      ...
      const s = JSON.parse(
        '{"id":"extend-chaos-daemon-interface","title":"Extend Chaos Daemon Interface","description":"In Add a new chaos experiment type, you have added HelloWorldChaos, which can print Hello world! in the logs of Chaos Controller Manager.","source":"@site/versioned_docs/version-2.6.2/extend-chaos-daemon-interface.md","sourceDirName":".","slug":"/extend-chaos-daemon-interface","permalink":"/docs/extend-chaos-daemon-interface","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.6.2/extend-chaos-daemon-interface.md","tags":[],"version":"2.6.2","frontMatter":{"title":"Extend Chaos Daemon Interface"},"sidebar":"docs","previous":{"title":"Add a New Chaos Experiment Type","permalink":"/docs/add-new-chaos-experiment-type"},"next":{"title":"Extend Chaosd","permalink":"/docs/extend-chaosd"}}'
      )
      var r = o(74848),
        a = o(28453),
        t = o(13137)
          ...
          children: [
            (0, r.jsxs)(n.p, {
              children: [
                ...
                ', you have added ',
                (0, r.jsx)(n.code, { children: 'HelloWorldChaos' }),
                ', which can print ',
                (0, r.jsx)(n.code, { children: 'Hello world!' }),
                ' in the logs of Chaos Controller Manager.',
              ],
            }),
            '\n',
            (0, r.jsxs)(n.p, {
              children: [
                'To enable the ',
                (0, r.jsx)(n.code, { children: 'HelloWorldChaos' }),
                ' to inject some faults into the target Pod, you need to extend Chaos Daemon interface.',
              ],
            }),
            '\n',
            (0, r.jsx)(n.admonition, {
              ...
              children: (0, r.jsxs)(n.p, {
                children: [
                  ...
                  (0, r.jsx)(n.a, { href: '/docs/#architecture-overview', children: 'the architecture of Chaos Mesh' }),
            ...
            (0, r.jsxs)(n.ul, {
              children: [
                ...
                (0, r.jsx)(n.li, {
                  children: (0, r.jsx)(n.a, {
                    href: '#verify-the-output-of-helloworldchaos',
                    children: 'Verify the output of HelloWorldChaos',
                  }),
                }),
                '\n',
            ...
            (0, r.jsxs)(n.p, {
              children: [
                'Selector can also be some more specific values (e.g. ',
                (0, r.jsx)(n.code, { children: 'AWSSelector' }),
                ' in ',
                (0, r.jsx)(n.code, { children: 'AWSChaos' }),
                '). Normally each chaos experiment needs only one selector, with exceptions like ',
                (0, r.jsx)(n.code, { children: 'NetworkChaos' }),
                ' because it sometimes needs two selectors as two objects for network partitioning.',
              ],
            }),
            '\n',
            (0, r.jsxs)(n.p, {
              children: [
                ...
                ' for more information about Selector.',
              ],
            }),
            '\n',
              ...
              children: [
                ...
                (0, r.jsxs)(n.li, {
                  children: [
                    ...
                    (0, r.jsxs)(n.p, {
                      children: [
                        'Then you need to update the related ',
                        (0, r.jsx)(n.code, { children: 'chaosdaemon.pb.go' }),
                ...
                (0, r.jsxs)(n.li, {
                  children: [
                    ...
                    (0, r.jsxs)(n.p, {
                      children: [
                        'Every chaos experiment has a life cycle: ',
                    ...
                    (0, r.jsxs)(n.p, {
                      children: [
                        'The chaos controller manager needs to send a request to the chaos daemon when ',
                        (0, r.jsx)(n.code, { children: 'HelloWorldChaos' }),
                        ' is in the ',
                        (0, r.jsx)(n.code, { children: 'apply' }),
                        ' phase. This is done by updating ',
                        (0, r.jsx)(n.code, { children: 'controllers/chaosimpl/helloworldchaos/types.go' }),
                        ':',
                      ],
                    }),
                    '\n',
                    ...
                    (0, r.jsx)(n.admonition, {
                      ...
                      children: (0, r.jsxs)(n.p, {
                        children: [
                          ...
                          (0, r.jsx)(n.code, { children: 'HelloWorldChaos' }),
                          ' is a ',
                          (0, r.jsx)(n.strong, { children: 'OneShot' }),
                          ' experiment. For the type of chaos experiment you develop, you can implement the logic of the recovery function as needed.',
                        ],
                      }),
                    }),
                    '\n',
            ...
            '\n',
            (0, r.jsx)(n.h2, {
              id: 'verify-the-output-of-helloworldchaos',
              children: 'Verify the output of HelloWorldChaos',
            }),
            '\n',
            (0, r.jsxs)(n.p, {
              children: ['Now you can verify the output of ', (0, r.jsx)(n.code, { children: 'HelloWorldChaos' }), ':'],
            }),
            '\n',
            (0, r.jsxs)(n.ol, {
              children: [
                ...
                (0, r.jsxs)(n.li, {
                  children: [
                    ...
                    (0, r.jsxs)(n.p, {
                      children: [
                        'Build Docker images as we described in ',
                        (0, r.jsx)(n.a, {
                          href: '/docs/add-new-chaos-experiment-type#step-4-build-docker-images',
                          children: 'Add a new chaos experiment type',
                        }),
                ...
                (0, r.jsxs)(n.li, {
                  children: [
                    ...
                    (0, r.jsxs)(n.p, {
                      children: [
                        'Create a ',
                        (0, r.jsx)(n.code, { children: 'hello-busybox.yaml' }),
                ...
                (0, r.jsxs)(n.li, {
                  children: [
                          ...
                          children: [
                            ...
                            (0, r.jsxs)(n.p, {
                              children: [
                                ...
                                (0, r.jsx)(n.code, { children: 'chaos-controller-manager' }),
                                ' has ',
                                (0, r.jsx)(n.code, { children: 'Apply helloworld chaos' }),
                                ' in its logs:',
                              ],
                            }),
                            '\n',
                            (0, r.jsx)(n.pre, {
                              children: (0, r.jsx)(n.code, {
                                className: 'language-bash',
                                children: 'kubectl logs -n chaos-mesh chaos-controller-manager-xxx\n',
                              }),
                            }),
                            '\n',
                        ...
                        (0, r.jsxs)(n.li, {
                          children: [
                            ...
                            (0, r.jsx)(n.pre, {
                              children: (0, r.jsx)(n.code, {
                                className: 'language-bash',
                                children: 'kubectl logs -n chaos-mesh chaos-daemon-xxx\n',
                              }),
                            }),
                            '\n',
                            (0, r.jsx)(n.p, { children: 'Example output:' }),
                    ...
                    (0, r.jsxs)(n.p, {
                      children: [
                        'You will see two separate lines of ',
                        (0, r.jsx)(n.code, { children: 'ps aux' }),
                        ', which are corresponding to two different Pods.',
                      ],
                    }),
                    '\n',
                  ],
            ...
            (0, r.jsxs)(n.p, {
              children: [
                ...
                (0, r.jsx)(n.a, { href: 'https://github.com/chaos-mesh/chaos-mesh/issues', children: 'issue' }),
            ...
            (0, r.jsxs)(n.p, {
              children: [
                'If you are curious about how all this works, you can read the ',
                (0, r.jsx)(n.a, {
                  href: 'https://github.com/chaos-mesh/chaos-mesh/blob/master/controllers/README.md',
                  children: 'controllers/README.md',
                }),
                ' and code for different controllers next.',
              ],
            }),
            '\n',
            (0, r.jsxs)(n.p, {
              children: [
                'You are now ready to become a Chaos Mesh developer! Feel free to visit the ',
                (0, r.jsx)(n.a, {
                  href: 'https://github.com/chaos-mesh/chaos-mesh/issues',
                  children: 'Chaos Mesh issues',
                }),
                ' to find a ',
                (0, r.jsx)(n.a, {
    ...
    13137: (e, n, o) => {
      ...
      const h = (e) => {
        ...
        const { siteConfig: l } = (0, r.A)(),
          { versions: h } = (0, a.P_)('docusaurus-plugin-content-docs')
        return (0, i.jsx)(s.A, {
          children: () => {
            const e = (0, d.t)(l, h),
              s =
            ...
            return (0, i.jsx)(t.A, { className: o, children: n.replace('--version latest', s).trim() })
          },
        })
      }
    },
    34661: (e, n, o) => {
      ...
      const c = (e, n) => {
        ...
        const r = n.find((e) => e.isLast),
          a = n.find((e) => o.includes(e.name))
        return a ? a.name : r.name
      }
      const d = (e) => {
        let { children: n, replaced: o = 'latest', isArchive: d = !1, className: i = 'language-bash' } = e
        const { siteConfig: h } = (0, r.A)(),
          { versions: p } = (0, a.P_)('docusaurus-plugin-content-docs')
        return (0, l.jsx)(s.A, {
          children: () => {
            const e = c(h, p),
              s = d
                ...
                ? n
                : n.replace(o, 'v' + e)
            return (0, l.jsx)(t.A, { className: i, children: s })
          },
        })
      }
    },
