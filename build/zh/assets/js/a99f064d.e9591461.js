...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [6738],
  {
    97885: (e, s, n) => {
      ...
      const a = JSON.parse(
        '{"id":"use-grafana-data-source","title":"\u4f7f\u7528 Grafana Data Source \u63d2\u4ef6\u8fdb\u884c\u89c2\u6d4b","description":"\u672c\u6587\u6863\u4ecb\u7ecd\u5982\u4f55\u5728\u672c\u5730 Grafana \u5b89\u88c5 Data Source \u63d2\u4ef6\uff0c\u5e76\u4f7f\u7528 Grafana Data Source \u8fdb\u884c\u89c2\u6d4b\u3002","source":"@site/i18n/zh/docusaurus-plugin-content-docs/version-2.4.3/use-grafana-data-source.md","sourceDirName":".","slug":"/use-grafana-data-source","permalink":"/zh/docs/2.4.3/use-grafana-data-source","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/i18n/zh/docusaurus-plugin-content-docs/version-2.4.3/use-grafana-data-source.md","tags":[],"version":"2.4.3","frontMatter":{"title":"\u4f7f\u7528 Grafana Data Source \u63d2\u4ef6\u8fdb\u884c\u89c2\u6d4b"},"sidebar":"docs","previous":{"title":"\u96c6\u6210 Chaos Mesh \u5230 GitHub Actions","permalink":"/zh/docs/2.4.3/integrate-chaos-mesh-into-github-actions"},"next":{"title":"Chaosctl","permalink":"/zh/docs/2.4.3/chaosctl-tool"}}'
      )
      var i = n(74848),
        c = n(28453)
          ...
          children: [
            ...
            (0, i.jsx)(s.admonition, {
              ...
              children: (0, i.jsxs)(s.ul, {
                children: [
                  '\n',
                  (0, i.jsx)(s.li, { children: 'Grafana \u5e94\u4e3a v7.0.0 \u6216\u66f4\u9ad8\u7248\u672c\u3002' }),
                  '\n',
                  (0, i.jsx)(s.li, { children: 'Chaos Mesh \u5e94\u4e3a v2.1.0 \u6216\u66f4\u9ad8\u7248\u672c\u3002' }),
                  '\n',
                ],
              }),
            }),
                  ...
                  children: [
                    ...
                    (0, i.jsxs)(s.p, {
                      children: [
                        ...
                        (0, i.jsx)(s.code, { children: 'grafana.ini' }),
                        '\uff0c\u5c06\u63d2\u4ef6\u6dfb\u52a0\u81f3 ',
                        (0, i.jsx)(s.code, { children: 'allow_loading_unsigned_plugins' }),
                  ...
                  children: [
                    ...
                    (0, i.jsxs)(s.p, {
                      children: [
                        ...
                        (0, i.jsx)(s.strong, { children: 'Configuration -> Data sources' }),
                    ...
                    (0, i.jsxs)(s.p, {
                      children: [
                        ...
                        (0, i.jsx)(s.code, { children: '2333' }),
                        ' \u7aef\u53e3\u5bfc\u51fa API\u3002\u56e0\u6b64\uff0c\u5982\u679c\u4f60\u6ca1\u6709\u4fee\u6539\u4efb\u4f55\u4e1c\u897f\uff0c\u53ef\u4ee5\u76f4\u63a5\u5728 ',
                        (0, i.jsx)(s.code, { children: 'URL' }),
                        ' \u4e2d\u586b\u5199 ',
                        (0, i.jsx)(s.code, { children: 'http://localhost:2333' }),
                        '\u3002',
                      ],
                    }),
                    '\n',
                ...
                (0, i.jsxs)(s.li, {
                  children: [
                    ...
                    (0, i.jsxs)(s.p, {
                      children: [
                        '\u7136\u540e\u4f7f\u7528 ',
                        (0, i.jsx)(s.code, { children: 'port-forward' }),
                        ' \u547d\u4ee4\u8ba9 API \u53ef\u88ab\u5916\u90e8\u8bbf\u95ee:',
                      ],
                    }),
                    '\n',
                ...
                (0, i.jsxs)(s.li, {
                  children: [
                    ...
                    (0, i.jsxs)(s.p, {
                      children: [
                        '\u70b9\u51fb ',
                        (0, i.jsx)(s.strong, { children: 'Save & Test' }),
            ...
            '\n',
            (0, i.jsx)(s.h2, { id: 'query', children: 'Query' }),
            '\n',
            (0, i.jsx)(s.p, {
              children:
            ...
            (0, i.jsxs)(s.ul, {
              children: [
                ...
                (0, i.jsxs)(s.li, {
                  children: [
                    (0, i.jsx)(s.code, { children: 'Object ID' }),
                    ': \u901a\u8fc7\u5bf9\u8c61\u7684 UUID \u8fdb\u884c\u8fc7\u6ee4',
                  ],
                }),
                '\n',
                (0, i.jsxs)(s.li, {
                  children: [
                    (0, i.jsx)(s.code, { children: 'Namespace' }),
                    ': \u901a\u8fc7\u4e0d\u540c\u7684\u547d\u540d\u7a7a\u95f4\u8fdb\u884c\u8fc7\u6ee4',
                  ],
                }),
                '\n',
                ...
                (0, i.jsxs)(s.li, {
                  children: [
                    (0, i.jsx)(s.code, { children: 'Kind' }),
                    ': \u901a\u8fc7\u7c7b\u578b\uff08PodChaos, Schedule \u7b49\uff09\u8fdb\u884c\u8fc7\u6ee4',
                  ],
                }),
                '\n',
                (0, i.jsxs)(s.li, {
                  children: [(0, i.jsx)(s.code, { children: 'Limit' }), ': \u9650\u5236\u4e8b\u4ef6\u7684\u6570\u91cf'],
                }),
                '\n',
              ],
            }),
            ...
            (0, i.jsxs)(s.p, {
              children: [
                '\u5bf9\u8fd9\u4e9b\u9009\u9879\u7684\u8bbe\u7f6e\u4f1a\u4f5c\u4e3a\u53c2\u6570\u88ab\u4f20\u9012\u5230 ',
                (0, i.jsx)(s.code, { children: '/api/events' }),
                ' API \u4e2d\u3002',
              ],
            }),
            '\n',
            (0, i.jsx)(s.h2, { id: 'annotations', children: 'Annotations' }),
            '\n',
            (0, i.jsx)(s.p, {
              children:
            ...
            '\n',
            (0, i.jsx)(s.p, {
              children: (0, i.jsx)(s.img, { alt: 'Annotations', src: n(89842).A + '', width: '1280', height: '1300' }),
            }),
            '\n',
            (0, i.jsxs)(s.p, {
              children: [
                '\u5982\u9700\u4e86\u89e3\u5982\u4f55\u586b\u5199 Annotations \u4e2d\u7684\u5b57\u6bb5\uff0c\u8bf7\u53c2\u8003 ',
                (0, i.jsx)(s.a, { href: '#query', children: 'Query' }),
                '\u3002',
              ],
            }),
            '\n',
            ...
            '\n',
            (0, i.jsx)(s.p, {
              children: (0, i.jsx)(s.img, { alt: 'Variables', src: n(72815).A + '', width: '1860', height: '1280' }),
            }),
            '\n',
            (0, i.jsx)(s.p, {
              ...
              children: [
                ...
                (0, i.jsxs)(s.li, {
                  children: [
                    ...
                    (0, i.jsx)(s.code, { children: 'Preview of values' }),
                    '\u3002',
                  ],
                }),
                '\n',
                ...
                (0, i.jsxs)(s.li, {
                  children: [
                    (0, i.jsx)(s.code, { children: 'Experiment' }),
                    ': \u4e0e\u547d\u540d\u7a7a\u95f4\u76f8\u540c\u3002\u83b7\u53d6\u6240\u6709\u5b9e\u9a8c\u7684\u540d\u79f0\u3002',
                  ],
                }),
                '\n',
            ...
            (0, i.jsxs)(s.p, {
              children: [
                ...
                (0, i.jsx)(s.a, { href: 'https://github.com/chaos-mesh/datasource/issues', children: 'issue' }),
                ' \u5411 Chaos Mesh \u56e2\u961f\u53cd\u9988\u3002',
              ],
            }),
            '\n',
            (0, i.jsx)(s.h2, { id: '\u63a2\u7d22\u66f4\u591a', children: '\u63a2\u7d22\u66f4\u591a' }),
            '\n',
            (0, i.jsxs)(s.p, {
              children: [
                '\u5982\u679c\u4f60\u60f3\u4e86\u89e3\u66f4\u591a\u5185\u5bb9\uff0c \u6b22\u8fce\u5728 ',
    ...
    89842: (e, s, n) => {
      n.d(s, { A: () => a })
      const a = n.p + 'assets/images/annotations-b9e5e1fd76f38a49dd9886922307fc69.png'
    },
    42393: (e, s, n) => {
      n.d(s, { A: () => a })
      const a = n.p + 'assets/images/settings-665c0b7d82f112c4cfc6e7555ff5fecb.png'
    },
    72815: (e, s, n) => {
      n.d(s, { A: () => a })
      const a = n.p + 'assets/images/variables-a7c176c8c7d5421dc93e921d29d697a5.png'
    },
    28453: (e, s, n) => {
      n.d(s, { R: () => r, x: () => l })
      var a = n(96540)
        ...
        return (
          (s = e.disableParentContext
            ? 'function' == typeof e.components
              ...
              : e.components || i
            : r(e.components)),
          a.createElement(c.Provider, { value: s }, e.children)
        )
      }
    },
  },
