...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [1449],
  {
    20872: (e, s, n) => {
      ...
      function h(e) {
        const s = { a: 'a', h2: 'h2', img: 'img', li: 'li', p: 'p', ul: 'ul', ...(0, i.R)(), ...e.components }
        return (0, t.jsxs)(t.Fragment, {
          children: [
            (0, t.jsxs)(s.p, {
              children: [
                'This document describes the basic features of Chaos Mesh, including ',
                (0, t.jsx)(s.a, { href: '#fault-injection', children: 'fault injection' }),
                ', ',
                (0, t.jsx)(s.a, { href: '#chaos-workflows', children: 'Chaos workflows' }),
                ', ',
                (0, t.jsx)(s.a, { href: '#visualized-operations', children: 'visualized operations' }),
                ', and ',
                (0, t.jsx)(s.a, { href: '#security-guarantees', children: 'security guarantees' }),
                '.',
              ],
            }),
            '\n',
            (0, t.jsx)(s.h2, { id: 'fault-injection', children: 'Fault injection' }),
            '\n',
            (0, t.jsx)(s.p, {
              children:
                    ...
                    (0, t.jsxs)(s.ul, {
                      children: [
                        ...
                        (0, t.jsxs)(s.li, {
                          children: [
                            (0, t.jsx)(s.a, {
                              href: '/docs/next/simulate-pod-chaos-on-kubernetes',
                              children: 'PodChaos',
                            }),
                        ...
                        (0, t.jsxs)(s.li, {
                          children: [
                            (0, t.jsx)(s.a, {
                              href: '/docs/next/simulate-dns-chaos-on-kubernetes',
                              children: 'DNSChaos',
                            }),
                        ...
                        (0, t.jsxs)(s.li, {
                          children: [
                            (0, t.jsx)(s.a, {
                              href: '/docs/next/simulate-http-chaos-on-kubernetes',
                              children: 'HTTPChaos',
                            }),
                        ...
                        (0, t.jsxs)(s.li, {
                          children: [
                            (0, t.jsx)(s.a, {
                              href: '/docs/next/simulate-heavy-stress-on-kubernetes',
                        ...
                        (0, t.jsxs)(s.li, {
                          children: [
                            (0, t.jsx)(s.a, {
                              href: '/docs/next/simulate-io-chaos-on-kubernetes',
                              children: 'IOChaos',
                            }),
                        ...
                        (0, t.jsxs)(s.li, {
                          children: [
                            (0, t.jsx)(s.a, {
                              href: '/docs/next/simulate-time-chaos-on-kubernetes',
                              children: 'TimeChaos',
                            }),
                        ...
                        (0, t.jsxs)(s.li, {
                          children: [
                            (0, t.jsx)(s.a, {
                              href: '/docs/next/simulate-kernel-chaos-on-kubernetes',
                  ...
                  children: [
                    ...
                    (0, t.jsxs)(s.ul, {
                      children: [
                        ...
                        (0, t.jsxs)(s.li, {
                          children: [
                            (0, t.jsx)(s.a, { href: '/docs/next/simulate-aws-chaos', children: 'AWSChaos' }),
                        ...
                        (0, t.jsxs)(s.li, {
                          children: [
                            (0, t.jsx)(s.a, { href: '/docs/next/simulate-gcp-chaos', children: 'GCPChaos' }),
                    ...
                    (0, t.jsxs)(s.ul, {
                      children: [
                        ...
                        (0, t.jsxs)(s.li, {
                          children: [
                            (0, t.jsx)(s.a, {
                              href: '/docs/next/simulate-jvm-application-chaos',
                              children: 'JVMChaos',
                            }),
            ...
            '\n',
            (0, t.jsx)(s.h2, { id: 'chaos-workflows', children: 'Chaos workflows' }),
            '\n',
            (0, t.jsx)(s.p, {
              children:
            ...
            '\n',
            (0, t.jsx)(s.p, { children: 'Currently, Chaos workflows provide the following features:' }),
            '\n',
            (0, t.jsxs)(s.ul, {
              children: [
                '\n',
                (0, t.jsx)(s.li, { children: 'Orchestrate serial Chaos experiments' }),
                '\n',
                (0, t.jsx)(s.li, { children: 'Orchestrate parallel Chaos experiments' }),
                '\n',
                (0, t.jsx)(s.li, { children: 'Support checking experimental status and results' }),
                '\n',
                (0, t.jsx)(s.li, { children: 'Support pausing a Chaos experiment' }),
                '\n',
                (0, t.jsx)(s.li, { children: 'Support using YAML files to define and manage Chaos workflows' }),
                '\n',
                (0, t.jsx)(s.li, { children: 'Support using the web UI to define and manage Chaos workflows' }),
                '\n',
              ],
            }),
            '\n',
            (0, t.jsxs)(s.p, {
              children: [
                ...
                (0, t.jsx)(s.a, {
                  href: '/docs/next/create-chaos-mesh-workflow',
            ...
            '\n',
            (0, t.jsx)(s.h2, { id: 'visualized-operations', children: 'Visualized operations' }),
            '\n',
            (0, t.jsx)(s.p, {
              children:
            ...
            '\n',
            (0, t.jsx)(s.h2, { id: 'security-guarantee', children: 'Security guarantee' }),
            '\n',
            (0, t.jsxs)(s.p, {
              children: [
        ...
        return (
          (s = e.disableParentContext
            ? 'function' == typeof e.components
              ...
              : e.components || t
            : o(e.components)),
          a.createElement(i.Provider, { value: s }, e.children)
        )
      }
    },
  },
