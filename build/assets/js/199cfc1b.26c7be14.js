...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [1909],
  {
    76620: (e, t, i) => {
      ...
      const l = JSON.parse(
        '{"id":"simulate-redis-chaos-on-physical-nodes","title":"Simulate Redis Faults","description":"This document introduces how to use Chaosd to simulate Redis faults. This feature uses Golang interfaces in go-redis package and the redis-server command-line tool. You can create experiments either in command-line mode or service mode.","source":"@site/versioned_docs/version-2.5.2/simulate-redis-chaos-on-physical-nodes.md","sourceDirName":".","slug":"/simulate-redis-chaos-on-physical-nodes","permalink":"/docs/2.5.2/simulate-redis-chaos-on-physical-nodes","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.5.2/simulate-redis-chaos-on-physical-nodes.md","tags":[],"version":"2.5.2","frontMatter":{"title":"Simulate Redis Faults"},"sidebar":"docs","previous":{"title":"Simulate File Faults","permalink":"/docs/2.5.2/simulate-file-chaos-in-physical-nodes"},"next":{"title":"Search and Recover Experiments of Chaosd","permalink":"/docs/2.5.2/chaosd-search-recover"}}'
      )
      var n = i(74848),
        s = i(28453)
