...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [8141],
  {
    5724: (e, s, n) => {
      ...
      const t = JSON.parse(
        '{"id":"simulate-process-chaos-in-physical-nodes","title":"Simulate Process Faults","description":"This document describes how to use Chaosd to simulate process faults. The process faults use the Golang interface of the kill command to simulate the scenarios that the process is killed or stopped. You can create experiments either in the command-line mode or service mode.","source":"@site/versioned_docs/version-2.4.3/simulate-process-chaos-in-physical-nodes.md","sourceDirName":".","slug":"/simulate-process-chaos-in-physical-nodes","permalink":"/docs/2.4.3/simulate-process-chaos-in-physical-nodes","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.4.3/simulate-process-chaos-in-physical-nodes.md","tags":[],"version":"2.4.3","frontMatter":{"title":"Simulate Process Faults"},"sidebar":"docs","previous":{"title":"Simulate Faults on Physical Machines","permalink":"/docs/2.4.3/simulate-physical-machine-chaos"},"next":{"title":"Simulate Network Faults","permalink":"/docs/2.4.3/simulate-network-chaos-in-physical-nodes"}}'
      )
      var l = n(74848),
        i = n(28453)
