  ...
  [7847],
  {
    ...
    13137: (e, s, a) => {
      ...
      const c = (e) => {
        ...
        const { siteConfig: d } = (0, n.A)(),
          { versions: c } = (0, r.P_)('docusaurus-plugin-content-docs')
        return (0, l.jsx)(t.A, {
          children: () => {
            const e = (0, h.t)(d, c),
              t =
                'latest' === e
                  ? ''
                  : `--version ${((e) => {
                      if (i().satisfies(e, '>=2.0.3')) return e
                      const s = e.slice(0, 3)
                      return 'v' + (parseFloat(s) - 0.7).toFixed(1) + e.slice(3)
                    })(e)}`
            return (0, l.jsx)(o.A, { className: a, children: s.replace('--version latest', t).trim() })
          },
        })
      }
    },
    34661: (e, s, a) => {
      ...
      const i = (e, s) => {
        ...
        const n = s.find((e) => e.isLast),
          r = s.find((e) => a.includes(e.name))
        return r ? r.name : n.name
      }
      const h = (e) => {
          ...
          children: () => {
            const e = i(c, u),
              t = h
                ...
                ? s
                : s.replace(a, 'v' + e)
            return (0, d.jsx)(o.A, { className: l, children: t })
          },
        })
      }
    },
