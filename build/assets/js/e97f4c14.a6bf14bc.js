...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [2302],
  {
    84778: (e, s, n) => {
      ...
      const t = JSON.parse(
        '{"id":"simulate-aws-chaos","title":"Simulate AWS Faults","description":"This document describes how to use Chaos Mesh to simulate AWS faults.","source":"@site/docs/simulate-aws-chaos.md","sourceDirName":".","slug":"/simulate-aws-chaos","permalink":"/docs/next/simulate-aws-chaos","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/docs/simulate-aws-chaos.md","tags":[],"version":"current","frontMatter":{"title":"Simulate AWS Faults"},"sidebar":"docs","previous":{"title":"Simulate Linux Kernel Faults","permalink":"/docs/next/simulate-kernel-chaos-on-kubernetes"},"next":{"title":"Simulate Azure Faults","permalink":"/docs/next/simulate-azure-chaos"}}'
      )
      var i = n(74848),
        c = n(28453)
      const r = { title: 'Simulate AWS Faults' },
        a = void 0,
        o = {},
        d = [
          ...
          {
            value: 'An <code>ec2-stop</code> configuration example',
            id: 'an-ec2-stop-configuration-example',
            level: 3,
          },
          {
            value: 'An <code>ec2-start</code> configuration example',
            id: 'an-ec2-start-configuration-example',
            level: 3,
          },
          {
      ...
      function l(e) {
        ...
        return (0, i.jsxs)(i.Fragment, {
          children: [
            (0, i.jsx)(s.p, { children: 'This document describes how to use Chaos Mesh to simulate AWS faults.' }),
            '\n',
            ...
            (0, i.jsxs)(s.ul, {
              children: [
                '\n',
                (0, i.jsxs)(s.li, {
                  children: [(0, i.jsx)(s.strong, { children: 'EC2 Stop' }), ': stops the specified EC2 instance.'],
                }),
                '\n',
                (0, i.jsxs)(s.li, {
                  children: [
                    (0, i.jsx)(s.strong, { children: 'EC2 Restart' }),
                ...
                (0, i.jsxs)(s.li, {
                  children: [
                    (0, i.jsx)(s.strong, { children: 'Detach Volume' }),
            ...
            (0, i.jsxs)(s.p, {
              children: [
                'To easily connect to the AWS cluster, you can create a Kubernetes ',
                (0, i.jsx)(s.code, { children: 'Secret' }),
                ' file to store the authentication information in advance.',
              ],
            }),
            '\n',
            (0, i.jsxs)(s.p, {
              children: ['A ', (0, i.jsx)(s.code, { children: 'Secret' }), ' file sample is as follows:'],
            }),
            '\n',
            (0, i.jsx)(s.pre, {
            ...
            (0, i.jsxs)(s.ul, {
              children: [
                '\n',
                (0, i.jsxs)(s.li, {
                  children: [(0, i.jsx)(s.strong, { children: 'name' }), ' means the Kubernetes Secret object.'],
                }),
                '\n',
                (0, i.jsxs)(s.li, {
                  children: [
                    (0, i.jsx)(s.strong, { children: 'namespace' }),
                ...
                (0, i.jsxs)(s.li, {
                  children: [
                    (0, i.jsx)(s.strong, { children: 'aws_access_key_id' }),
                    ' stores the ID of the access key to the AWS cluster.',
                  ],
                }),
                '\n',
                (0, i.jsxs)(s.li, {
                  children: [
                    (0, i.jsx)(s.strong, { children: 'aws_secret_access_key' }),
                    ' stores the secret access key to the AWS cluster.',
                  ],
                }),
                '\n',
                (0, i.jsxs)(s.li, {
                  children: [
                    (0, i.jsx)(s.strong, { children: 'aws_session_token' }),
                    ' stores the aws session token to the AWS cluster. (required when using ',
                    (0, i.jsx)(s.a, {
                      href: 'https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_use-resources.html',
                      children: 'temporary AWS credentials',
                    }),
                    ')',
                  ],
                }),
                      ...
                      children: [
                        ...
                        (0, i.jsxs)(s.p, {
                          children: [
                            ...
                            (0, i.jsx)(s.code, { children: 'kubectl port-forward' }),
                            ':',
                          ],
                        }),
                        '\n',
                        ...
                        (0, i.jsxs)(s.p, {
                          children: [
                            ...
                            (0, i.jsx)(s.a, {
                              ...
                              children: (0, i.jsx)(s.code, { children: 'http://localhost:2333' }),
                            }),
                            ' in your browser.',
                          ],
                        }),
              ...
              children: [
                ...
                (0, i.jsxs)(s.li, {
                  children: [
                    ...
                    '\n',
                    (0, i.jsx)(s.p, {
                      children: (0, i.jsx)(s.img, { alt: 'img', src: n(7278).A + '', width: '959', height: '519' }),
                    }),
                    '\n',
                  ],
                }),
                  ...
                  children: [
                    ...
                    (0, i.jsxs)(s.p, {
                      children: [
                        ...
                        ' area, choose ',
                        (0, i.jsx)(s.strong, { children: 'AWS FAULT' }),
                        ' and select a specific behavior, such as ',
                        (0, i.jsx)(s.strong, { children: 'STOP EC2' }),
                        '.',
                      ],
                    }),
                    '\n',
            ...
            (0, i.jsxs)(s.h3, {
              id: 'an-ec2-stop-configuration-example',
              children: ['An ', (0, i.jsx)(s.code, { children: 'ec2-stop' }), ' configuration example'],
            }),
            '\n',
            (0, i.jsxs)(s.ol, {
              children: [
                  ...
                  children: [
                    ...
                    (0, i.jsxs)(s.p, {
                      children: [
                        ...
                        (0, i.jsx)(s.code, { children: 'awschaos-ec2-stop.yaml' }),
                        ' file, as shown below:',
                      ],
                    }),
                    '\n',
                    ...
                    (0, i.jsxs)(s.p, {
                      children: [
                        ...
                        (0, i.jsx)(s.code, { children: 'ec2-stop' }),
                        ' fault into the specified EC2 instance so that the EC2 instance will be unavailable in 5 minutes.',
                      ],
                    }),
                    '\n',
                    (0, i.jsxs)(s.p, {
                      children: [
                        ...
                        (0, i.jsx)(s.a, {
                          ...
                          children: 'AWS documentation - Stop and start your instance',
                        }),
                        '.',
                      ],
                    }),
            ...
            (0, i.jsxs)(s.h3, {
              id: 'an-ec2-start-configuration-example',
              children: ['An ', (0, i.jsx)(s.code, { children: 'ec2-start' }), ' configuration example'],
            }),
            '\n',
            (0, i.jsxs)(s.ol, {
              children: [
                ...
                (0, i.jsxs)(s.li, {
                  children: [
                    ...
                    (0, i.jsxs)(s.p, {
                      children: [
                        'Write the experiment configuration to the ',
                        (0, i.jsx)(s.code, { children: 'awchaos-ec2-restot.yaml' }),
                        ' file:',
                      ],
                    }),
                    '\n',
                    ...
                    (0, i.jsxs)(s.p, {
                      children: [
                        ...
                        (0, i.jsx)(s.code, { children: 'ec2-restart' }),
                        ' fault into the specified EC2 instance so that the EC2 instance will be restarted.',
                      ],
                    }),
                    '\n',
                    (0, i.jsxs)(s.p, {
                      children: [
                        'For more information about restarting the EC2 instance, refer to the ',
                        (0, i.jsx)(s.a, {
                          href: 'https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-reboot.html',
                          children: 'AWS documentation - Reboot your instance',
                        }),
                        '.',
                      ],
                    }),
            ...
            (0, i.jsxs)(s.h3, {
              id: 'a-detach-volume-configuration-example',
              children: ['A ', (0, i.jsx)(s.code, { children: 'detach-volume' }), ' configuration example'],
            }),
            '\n',
            (0, i.jsxs)(s.ol, {
              children: [
                ...
                (0, i.jsxs)(s.li, {
                  children: [
                    ...
                    (0, i.jsxs)(s.p, {
                      children: [
                        'Write the experiment configuration to the ',
                        (0, i.jsx)(s.code, { children: 'awschaos-detach-volume.yaml' }),
                        ' file:',
                      ],
                    }),
                    '\n',
                    ...
                    (0, i.jsxs)(s.p, {
                      children: [
                        ...
                        (0, i.jsx)(s.code, { children: 'detail-volume' }),
                        ' fault into the specified EC2 instance so that the EC2 instance is detached from the specified storage volume within 5 minutes.',
                      ],
                    }),
                    '\n',
                    (0, i.jsxs)(s.p, {
                      children: [
                        ...
                        (0, i.jsx)(s.a, {
                          href: 'https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-detaching-volume.html',
                          children: 'AWS documentation - Detach an Amazon EBS volume from a Linux instance',
                        }),
                        '.',
                      ],
                    }),
              ...
              children: [
                ...
                (0, i.jsxs)(s.tbody, {
                  children: [
                    (0, i.jsxs)(s.tr, {
                      children: [
                        (0, i.jsx)(s.td, { children: 'action' }),
                        (0, i.jsx)(s.td, { children: 'string' }),
                        (0, i.jsx)(s.td, {
                          children:
                            'Indicates the specific type of faults. Only ec2-stop, ec2-restore, and detain-volume are supported.',
                        }),
                        (0, i.jsx)(s.td, { children: 'ec2-stop' }),
                    ...
                    (0, i.jsxs)(s.tr, {
                      children: [
                        (0, i.jsx)(s.td, { children: 'secretName' }),
                        (0, i.jsx)(s.td, { children: 'string' }),
                        (0, i.jsx)(s.td, {
                          children:
                        ...
                        (0, i.jsx)(s.td, { children: 'None' }),
                        (0, i.jsx)(s.td, { children: 'No' }),
                        (0, i.jsx)(s.td, { children: 'cloud-key-secret' }),
                      ],
                    }),
                    (0, i.jsxs)(s.tr, {
                      children: [
                        (0, i.jsx)(s.td, { children: 'awsRegion' }),
                        (0, i.jsx)(s.td, { children: 'string' }),
                        (0, i.jsx)(s.td, { children: 'Specifies the AWS region.' }),
                        (0, i.jsx)(s.td, { children: 'None' }),
                        (0, i.jsx)(s.td, { children: 'Yes' }),
                        (0, i.jsx)(s.td, { children: 'us-east-2' }),
                      ],
                    }),
                    (0, i.jsxs)(s.tr, {
                      children: [
                        (0, i.jsx)(s.td, { children: 'ec2Instance' }),
                        (0, i.jsx)(s.td, { children: 'string' }),
                        (0, i.jsx)(s.td, { children: 'Specifies the ID of the EC2 instance.' }),
                        (0, i.jsx)(s.td, { children: 'None' }),
                        (0, i.jsx)(s.td, { children: 'Yes' }),
                        (0, i.jsx)(s.td, { children: 'your-ec2-instance-id' }),
                      ],
                    }),
                    (0, i.jsxs)(s.tr, {
                      children: [
                        (0, i.jsx)(s.td, { children: 'volumeID' }),
                        (0, i.jsx)(s.td, { children: 'string' }),
                        (0, i.jsxs)(s.td, {
                          children: [
                            'This is a required field when the ',
                            (0, i.jsx)(s.code, { children: 'action' }),
                            ' is ',
                            (0, i.jsx)(s.code, { children: 'detach-volume' }),
                            '. This field specifies the EBS volume ID.',
                          ],
                        }),
                        (0, i.jsx)(s.td, { children: 'None' }),
                        (0, i.jsx)(s.td, { children: 'No' }),
                        (0, i.jsx)(s.td, { children: 'your-volume-id' }),
                      ],
                    }),
                    (0, i.jsxs)(s.tr, {
                      children: [
                        (0, i.jsx)(s.td, { children: 'deviceName' }),
                        (0, i.jsx)(s.td, { children: 'string' }),
                        (0, i.jsxs)(s.td, {
                          children: [
                            'This is a required field when the ',
                            ...
                            ' is ',
                            (0, i.jsx)(s.code, { children: 'detach-volume' }),
                            '. This field specifies the machine name.',
                          ],
                        }),
                        (0, i.jsx)(s.td, { children: 'None' }),
                        (0, i.jsx)(s.td, { children: 'No' }),
                        (0, i.jsx)(s.td, { children: '/dev/sdf' }),
                      ],
                    }),
                    (0, i.jsxs)(s.tr, {
                      children: [
