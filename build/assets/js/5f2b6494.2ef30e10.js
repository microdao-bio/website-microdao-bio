  ...
  [8243],
  {
    43057: (e, s, n) => {
      ...
      const t = {},
        ...
        h = []
      function l(e) {
        const s = { a: 'a', p: 'p', ...(0, i.R)(), ...e.components }
          ...
          children: [
            ...
            (0, a.jsxs)(s.p, {
              children: [
                ...
                (0, a.jsx)(s.a, { href: '/docs/run-a-chaos-experiment', children: 'Run a Chaos experiment' }),
    ...
    78465: (e, s, n) => {
      ...
      const t = {},
        ...
        h = []
      function l(e) {
        const s = { admonition: 'admonition', code: 'code', p: 'p', pre: 'pre', ...(0, i.R)(), ...e.components }
        return (0, a.jsxs)(a.Fragment, {
          children: [
    ...
    39302: (e, s, n) => {
      ...
      const o = JSON.parse(
        '{"id":"offline-installation","title":"Install Chaos Mesh Offline","description":"This document describes how to install Chaos Mesh offline.","source":"@site/versioned_docs/version-2.6.2/offline-installation.md","sourceDirName":".","slug":"/offline-installation","permalink":"/docs/offline-installation","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.6.2/offline-installation.md","tags":[],"version":"2.6.2","frontMatter":{"title":"Install Chaos Mesh Offline"},"sidebar":"docs","previous":{"title":"Install Chaos Mesh using Helm","permalink":"/docs/production-installation-using-helm"},"next":{"title":"Expose Chaos Dashboard with Ingress","permalink":"/docs/expose-dashboard-with-ingress"}}'
      )
      var a = n(74848),
        i = n(28453),
        t = n(34661),
      ...
      function p(e) {
        ...
        return (0, a.jsxs)(a.Fragment, {
          children: [
            ...
            '\n',
            (0, a.jsx)(t.A, { children: 'export CHAOS_MESH_VERSION=latest' }),
            '\n',
            ...
            '\n',
            (0, a.jsx)(t.A, { children: 'export CHAOS_MESH_VERSION=latest; export DOCKER_REGISTRY=localhost:5000' }),
            '\n',
    ...
    13137: (e, s, n) => {
      ...
      const d = (e) => {
        ...
        const { siteConfig: r } = (0, a.A)(),
          { versions: d } = (0, i.P_)('docusaurus-plugin-content-docs')
        return (0, l.jsx)(o.A, {
          children: () => {
            const e = (0, h.t)(r, d),
              o =
            ...
            return (0, l.jsx)(t.A, { className: n, children: s.replace('--version latest', o).trim() })
          },
        })
      }
    },
    34661: (e, s, n) => {
      ...
      const c = (e, s) => {
        ...
        const a = s.find((e) => e.isLast),
          i = s.find((e) => n.includes(e.name))
        return i ? i.name : a.name
      }
      const h = (e) => {
        let { children: s, replaced: n = 'latest', isArchive: h = !1, className: l = 'language-bash' } = e
        const { siteConfig: d } = (0, a.A)(),
          { versions: m } = (0, i.P_)('docusaurus-plugin-content-docs')
        return (0, r.jsx)(o.A, {
          children: () => {
            const e = c(d, m),
              o = h
                ...
                ? s
                : s.replace(n, 'v' + e)
            return (0, r.jsx)(t.A, { className: l, children: o })
          },
        })
      }
    },
