...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [11],
  {
    82557: (e, s, n) => {
      ...
      const t = JSON.parse(
        '{"id":"inspect-chaos-experiments","title":"Inspect Results of Chaos Experiments","description":"This document describes how to use Chaos Mesh to check running status and results of chaos experiments.","source":"@site/docs/inspect-chaos-experiments.md","sourceDirName":".","slug":"/inspect-chaos-experiments","permalink":"/docs/next/inspect-chaos-experiments","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/docs/inspect-chaos-experiments.md","tags":[],"version":"current","frontMatter":{"title":"Inspect Results of Chaos Experiments"},"sidebar":"docs","previous":{"title":"Run a Chaos Experiment","permalink":"/docs/next/run-a-chaos-experiment"},"next":{"title":"Create Chaos Mesh Workflow","permalink":"/docs/next/create-chaos-mesh-workflow"}}'
      )
      var i = n(74848),
        c = n(28453)
              ...
              children: [
                ...
                (0, i.jsxs)(s.li, {
                  children: [
                    ...
                    (0, i.jsx)(s.a, {
                      href: '/docs/next/run-a-chaos-experiment#pause-chaos-experiments',
                      children: 'paused',
                    }),
