...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [1228],
  {
    34517: (e, n, s) => {
      ...
      const o = JSON.parse(
        '{"id":"manage-user-permissions","title":"Manage User Permissions","description":"This document describes how to manage user permissions in Chaos Mesh, including creating user accounts with different roles, binding permissions to user accounts, managing tokens, and enabling or disabling permission authentication.","source":"@site/versioned_docs/version-2.5.2/manage-user-permissions.md","sourceDirName":".","slug":"/manage-user-permissions","permalink":"/docs/2.5.2/manage-user-permissions","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.5.2/manage-user-permissions.md","tags":[],"version":"2.5.2","frontMatter":{"title":"Manage User Permissions"},"sidebar":"docs","previous":{"title":"Uninstall Chaos Mesh","permalink":"/docs/2.5.2/uninstallation"},"next":{"title":"Configure namespace for Chaos experiments","permalink":"/docs/2.5.2/configure-enabled-namespace"}}'
      )
      var t = s(74848),
        a = s(28453),
        i = s(13137)
          ...
          children: [
            ...
            (0, t.jsxs)(n.p, {
              children: [
                ...
                (0, t.jsx)(n.code, { children: 'apiGroups' }),
                ' of ',
                (0, t.jsx)(n.code, { children: 'chaos-mesh.org' }),
            ...
            (0, t.jsxs)(n.p, {
              children: [
                ...
                (0, t.jsx)(n.strong, { children: 'Click here to generate' }),
                ' link:',
              ],
            }),
            '\n',
            ...
            '\n',
            (0, t.jsx)(n.p, { children: 'When you click on the link, a Token Generator will appear, as follows:' }),
            '\n',
            (0, t.jsx)(n.p, {
              children: (0, t.jsx)(n.img, {
            ...
            '\n',
            (0, t.jsx)(n.p, { children: 'The steps to create user accounts and bind permissions are as follows:' }),
            '\n',
            (0, t.jsx)(n.h3, { id: 'choose-the-scope-of-permissions', children: 'Choose the scope of permissions' }),
            '\n',
            (0, t.jsxs)(n.p, {
              children: [
                'If you want to give the account the appropriate permissions for all chaos experiments in the cluster, tick the ',
                (0, t.jsx)(n.strong, { children: 'Cluster scoped' }),
            ...
            '\n',
            (0, t.jsx)(n.p, { children: 'In summary, there are two options to choose from:' }),
            '\n',
            (0, t.jsxs)(n.ul, {
              children: [
                '\n',
                (0, t.jsxs)(n.li, {
                  children: [
                    (0, t.jsx)(n.code, { children: 'Cluster scoped' }),
                ...
                (0, t.jsxs)(n.li, {
                  children: [
                    (0, t.jsx)(n.code, { children: 'Namespace scoped' }),
            ...
            '\n',
            (0, t.jsx)(n.h3, { id: 'select-the-role-of-users', children: 'Select the role of users' }),
            '\n',
            (0, t.jsx)(n.p, { children: 'Currently, Chaos Mesh provides the following user roles' }),
            '\n',
            (0, t.jsxs)(n.ul, {
              children: [
                '\n',
                ...
                (0, t.jsxs)(n.li, {
                  children: [
                    (0, t.jsx)(n.code, { children: 'Viewer' }),
            ...
            '\n',
            (0, t.jsx)(n.h3, { id: 'generate-the-permission', children: 'Generate the permission' }),
            '\n',
            (0, t.jsxs)(n.p, {
              children: [
            ...
            (0, t.jsxs)(n.p, {
              children: [
                'Click ',
                (0, t.jsx)(n.strong, { children: 'COPY' }),
                ...
                (0, t.jsx)(n.code, { children: 'rbac.yaml' }),
                '.',
              ],
            }),
            '\n',
            ...
            '\n',
            (0, t.jsx)(n.pre, {
              children: (0, t.jsx)(n.code, { className: 'language-bash', children: 'kubectl apply -f rbac.yaml\n' }),
            }),
            '\n',
            ...
            '\n',
            (0, t.jsx)(n.h3, { id: 'get-the-token', children: 'Get the token' }),
            '\n',
            (0, t.jsxs)(n.admonition, {
              type: 'info',
              children: [
            ...
            '\n',
            (0, t.jsx)(n.p, { children: 'Copy the token at the bottom and use it in the next step to login.' }),
            '\n',
            (0, t.jsx)(n.h2, {
              id: 'log-in-to-chaos-dashboard-with-the-user-account-you-have-created',
            ...
            (0, t.jsxs)(n.p, {
              children: [
                (0, t.jsx)(n.strong, { children: 'Close' }),
                ' the Token Generator. In the ',
                (0, t.jsx)(n.strong, { children: 'Token' }),
                ' field, enter the token you obtained in the previous step and in the ',
                (0, t.jsx)(n.strong, { children: 'Name' }),
                ...
                (0, t.jsx)(n.code, { children: 'default-manager' }),
            ...
            '\n',
            (0, t.jsx)(n.h2, { id: 'log-out-of-chaos-dashboard', children: 'Log out of Chaos Dashboard' }),
            '\n',
            (0, t.jsxs)(n.p, {
              children: [
            ...
            (0, t.jsxs)(n.p, {
              children: [
                ...
                (0, t.jsx)(n.strong, { children: 'Logout' }),
            ...
            (0, t.jsxs)(n.p, {
              children: [
                ...
                (0, t.jsx)(n.code, { children: '--set dashboard.securityMode=false' }),
            ...
            (0, t.jsxs)(n.p, {
              children: [
                ...
                (0, t.jsx)(n.code, { children: '--set dashboard.securityMode=true' }),
                ' in a Helm command.',
              ],
            }),
          ],
      ...
      const d = (e) => {
        ...
        return (0, h.jsx)(o.A, {
          children: () => {
            ...
            return (0, h.jsx)(i.A, { className: s, children: n.replace('--version latest', o).trim() })
          },
        })
      }
    },
          ...
          children: () => {
            const e = c(d, u),
              o = l
                ...
                ? n
                : n.replace(s, 'v' + e)
            return (0, r.jsx)(i.A, { className: h, children: o })
          },
        })
      }
    },
    68345: (e, n, s) => {
      s.d(n, { A: () => o })
      const o = s.p + 'assets/images/dashboard_login1-dfdb1c8e7065189206548133f4268ded.png'
    },
    1762: (e, n, s) => {
      s.d(n, { A: () => o })
      const o = s.p + 'assets/images/dashboard_login2-04fcd7cd8c409649d558011f74b3ea4c.png'
    },
    76764: (e, n, s) => {
      s.d(n, { A: () => o })
      const o = s.p + 'assets/images/token_helper-7295fb5793a10defbb506193f39df948.png'
    },
    56266: (e, n, s) => {
      s.d(n, { A: () => o })
      const o = s.p + 'assets/images/token_logout-e5c9c5cfca099f33e47ab979053d806f.png'
    },
  },
])
