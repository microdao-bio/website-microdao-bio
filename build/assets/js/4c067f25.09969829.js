...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [8030],
  {
    44447: (e, n, s) => {
      ...
      const i = JSON.parse(
        '{"id":"simulate-block-chaos-on-kubernetes","title":"Simulate Block Device Incidents","description":"BlockChaos Introduction","source":"@site/versioned_docs/version-2.6.2/simulate-block-chaos-on-kubernetes.md","sourceDirName":".","slug":"/simulate-block-chaos-on-kubernetes","permalink":"/docs/simulate-block-chaos-on-kubernetes","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.6.2/simulate-block-chaos-on-kubernetes.md","tags":[],"version":"2.6.2","frontMatter":{"title":"Simulate Block Device Incidents"},"sidebar":"docs","previous":{"title":"Simulate HTTP Faults","permalink":"/docs/simulate-http-chaos-on-kubernetes"},"next":{"title":"Chaosd Introduction","permalink":"/docs/chaosd-overview"}}'
      )
      var l = s(74848),
        d = s(28453)
      const c = { title: 'Simulate Block Device Incidents' },
        o = void 0,
        t = {},
        r = [
          ...
          children: [
            ...
            (0, l.jsx)(n.admonition, {
              ...
              children: (0, l.jsxs)(n.p, {
                children: [
                  'BlockChaos ',
                  (0, l.jsx)(n.code, { children: 'freeze' }),
                  ...
                  children: [
                    ...
                    (0, l.jsxs)(n.tr, {
                      children: [
                        ...
                        (0, l.jsxs)(n.td, {
                          children: [
                            'Indicates the specific type of faults. The available fault types include ',
                            (0, l.jsx)(n.code, { children: 'delay' }),
                            ' and ',
                            (0, l.jsx)(n.code, { children: 'freeze' }),
                            '. ',
                            (0, l.jsx)(n.code, { children: 'delay' }),
                            ' will simulate the latency of block devices, and ',
                            (0, l.jsx)(n.code, { children: 'freeze' }),
                            ' will simulate that the block device cannot handle any requests',
                          ],
                        }),
                        (0, l.jsx)(n.td, { children: 'None' }),
                        (0, l.jsx)(n.td, { children: 'Yes' }),
                        (0, l.jsx)(n.td, { children: (0, l.jsx)(n.code, { children: 'delay' }) }),
                      ],
                    }),
                    (0, l.jsxs)(n.tr, {
                      children: [
                        (0, l.jsx)(n.td, { children: (0, l.jsx)(n.code, { children: 'delay.latency' }) }),
                        (0, l.jsx)(n.td, { children: 'string' }),
