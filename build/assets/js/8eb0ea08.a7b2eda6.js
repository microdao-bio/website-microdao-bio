...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [922],
  {
    15534: (e, t, n) => {
      ...
      const i = JSON.parse(
        '{"id":"simulate-jvm-application-chaos-in-physical-nodes","title":"Simulate JVM Application Faults","description":"Chaosd simulates the faults of JVM application through Byteman. The supported fault types are as follows:","source":"@site/versioned_docs/version-2.4.3/simulate-jvm-application-chaos-in-physical-nodes.md","sourceDirName":".","slug":"/simulate-jvm-application-chaos-in-physical-nodes","permalink":"/docs/2.4.3/simulate-jvm-application-chaos-in-physical-nodes","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.4.3/simulate-jvm-application-chaos-in-physical-nodes.md","tags":[],"version":"2.4.3","frontMatter":{"title":"Simulate JVM Application Faults"},"sidebar":"docs","previous":{"title":"Simulate Disk Faults","permalink":"/docs/2.4.3/simulate-disk-pressure-in-physical-nodes"},"next":{"title":"Simulate Time Faults","permalink":"/docs/2.4.3/simulate-time-chaos-on-physical-nodes"}}'
      )
      var s = n(74848),
        l = n(28453)
