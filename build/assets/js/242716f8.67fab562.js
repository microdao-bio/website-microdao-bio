...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [7263],
  {
    27713: (e, s, n) => {
      ...
      const o = JSON.parse(
        '{"id":"chaosctl-tool","title":"Chaosctl","description":"Chaosctl is a tool to assist in debugging Chaos Mesh. With Chaosctl, you can simplify the process of developing and debugging new chaos types, and provide references for other developers when raising an issue.","source":"@site/docs/chaosctl-tool.md","sourceDirName":".","slug":"/chaosctl-tool","permalink":"/docs/next/chaosctl-tool","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/docs/chaosctl-tool.md","tags":[],"version":"current","frontMatter":{"title":"Chaosctl"},"sidebar":"docs","previous":{"title":"Use Grafana Data Source Plugin for Observations","permalink":"/docs/next/use-grafana-data-source"},"next":{"title":"Developer Guide Overview","permalink":"/docs/next/developer-guide-overview"}}'
      )
      var t = n(74848),
        c = n(28453)
              ...
              children: [
                ...
                (0, t.jsxs)(s.li, {
                  children: [
                    ...
                    (0, t.jsx)(s.a, {
                      href: '/docs/next/simulate-physical-machine-chaos#deploy-chaosd-server',
