...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [9095],
  {
    95567: (e, s, o) => {
      ...
      const t = JSON.parse(
        '{"id":"faqs","title":"FAQs","description":"If I do not have deployed Kubernetes clusters, can I use Chaos Mesh to create chaos experiments?","source":"@site/versioned_docs/version-2.5.2/faqs.md","sourceDirName":".","slug":"/faqs","permalink":"/docs/2.5.2/faqs","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.5.2/faqs.md","tags":[],"version":"2.5.2","frontMatter":{"title":"FAQs"},"sidebar":"docs","previous":{"title":"Extend Chaosd","permalink":"/docs/2.5.2/extend-chaosd"},"next":{"title":"Upgrade to Chaos Mesh 2.0","permalink":"/docs/2.5.2/upgrade-to-2.0"}}'
      )
      var n = o(74848),
        i = o(28453),
        a = o(13137)
        ...
        return (0, n.jsxs)(n.Fragment, {
          children: [
            ...
            (0, n.jsxs)(s.p, {
              children: [
                ...
                (0, n.jsx)(s.a, {
                  ...
                  children: (0, n.jsx)(s.code, { children: 'chaosd' }),
                }),
            ...
            (0, n.jsxs)(s.p, {
              children: [
                'The reason is that ',
                (0, n.jsx)(s.code, { children: 'chaos-controller-manager' }),
                ' failed to connect to ',
                (0, n.jsx)(s.code, { children: 'chaos-daemon' }),
            ...
            (0, n.jsxs)(s.p, {
              children: [
                ...
                (0, n.jsx)(s.code, { children: 'hostNetwork' }),
            ...
            (0, n.jsxs)(s.p, {
              children: [
                ...
                (0, n.jsx)(s.code, { children: 'AdmissionReview' }),
            ...
            (0, n.jsxs)(s.p, {
              children: [
                'The ',
                (0, n.jsx)(s.code, { children: 'USER_ACCOUNT' }),
            ...
            (0, n.jsxs)(s.h3, {
              ...
              children: [
                ...
                (0, n.jsx)(s.code, { children: 'version 1.41 is too new. The maximum supported API version is 1.39' }),
              ],
            }),
            '\n',
            (0, n.jsxs)(s.p, {
              children: [
                ...
                (0, n.jsx)(s.code, { children: '1.39' }),
                ', but the client in ',
                (0, n.jsx)(s.code, { children: 'chaos-daemon' }),
                ' uses ',
                (0, n.jsx)(s.code, { children: '1.41' }),
            ...
            (0, n.jsxs)(s.ol, {
              children: [
                '\n',
                (0, n.jsx)(s.li, { children: 'Upgrade your Docker to a newer version.' }),
                '\n',
                (0, n.jsxs)(s.li, {
                  children: [
                    'Helm install/upgrade with ',
                    (0, n.jsx)(s.code, { children: '--set chaosDaemon.env.DOCKER_API_VERSION=1.39' }),
                    '.',
                  ],
                }),
                '\n',
            ...
            '\n',
            (0, n.jsx)(s.h2, { id: 'dnschaos', children: 'DNSChaos' }),
            '\n',
            (0, n.jsx)(s.h3, {
              id: 'while-trying-to-run-dnschaos-in-openshift-the-problems-regarding-authorization-blocked-the-process',
              children:
            ...
            '\n',
            (0, n.jsx)(s.p, { children: 'If the error message is similar to the following:' }),
            '\n',
            (0, n.jsx)(s.pre, {
              children: (0, n.jsx)(s.code, {
            ...
            (0, n.jsxs)(s.p, {
              children: [
                ...
                (0, n.jsx)(s.code, { children: 'chaos-dns-server' }),
                '.',
              ],
            }),
            '\n',
            ...
            '\n',
            (0, n.jsx)(s.p, { children: 'You need to add privileged scc to default.' }),
            '\n',
            (0, n.jsx)(s.pre, {
              children: (0, n.jsx)(s.code, {
                className: 'language-bash',
            ...
            (0, n.jsxs)(s.p, {
              children: [
                ...
                (0, n.jsx)(s.code, { children: 'apiextensions.k8s.io/v1' }),
            ...
            (0, n.jsxs)(s.ol, {
              children: [
                ...
                (0, n.jsxs)(s.li, {
                  children: [
                    'Add ',
                    (0, n.jsx)(s.code, { children: '--validate=false' }),
                ...
                (0, n.jsxs)(s.li, {
                  children: [
                    ...
                    (0, n.jsx)(s.code, { children: '--skip-crds' }),
                    ' with ',
                    (0, n.jsx)(s.code, { children: 'helm install' }),
                    ' command.',
                  ],
                }),
                '\n',
      ...
      const h = (e) => {
        ...
        return (0, d.jsx)(t.A, {
          children: () => {
            ...
            return (0, d.jsx)(a.A, { className: o, children: s.replace('--version latest', t).trim() })
          },
        })
      }
    },
    34661: (e, s, o) => {
      ...
      const l = (e, s) => {
        ...
        if (o === e.baseUrl && t) return 'current' === t ? 'latest' : t
        if (o.includes('/docs/next')) return 'latest'
        const n = s.find((e) => e.isLast),
          i = s.find((e) => o.includes(e.name))
        return i ? i.name : n.name
      }
      const c = (e) => {
        let { children: s, replaced: o = 'latest', isArchive: c = !1, className: d = 'language-bash' } = e
        const { siteConfig: h } = (0, n.A)(),
          ...
          children: () => {
            const e = l(h, u),
              t = c
                ...
                ? s
                : s.replace(o, 'v' + e)
            return (0, r.jsx)(a.A, { className: d, children: t })
          },
        })
      }
    },
