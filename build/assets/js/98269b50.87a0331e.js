...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [646],
  {
    39939: (e, t, n) => {
      ...
      const s = JSON.parse(
        '{"id":"integrate-chaos-mesh-into-github-actions","title":"Integrate Chaos Mesh to GitHub Actions","description":"This document describes how to integrate Chaos Mesh to customize the continuous integration (CI) using chaos-mesh-action. This helps you identify issues that have been introduced into system development before product releases.","source":"@site/versioned_docs/version-2.4.3/integrate-chaos-mesh-into-github-actions.md","sourceDirName":".","slug":"/integrate-chaos-mesh-into-github-actions","permalink":"/docs/2.4.3/integrate-chaos-mesh-into-github-actions","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.4.3/integrate-chaos-mesh-into-github-actions.md","tags":[],"version":"2.4.3","frontMatter":{"title":"Integrate Chaos Mesh to GitHub Actions"},"sidebar":"docs","previous":{"title":"GCP OAuth Authentication","permalink":"/docs/2.4.3/gcp-authentication"},"next":{"title":"Use Grafana Data Source Plugin for Observations","permalink":"/docs/2.4.3/use-grafana-data-source"}}'
      )
      var o = n(74848),
        i = n(28453)
      const a = { title: 'Integrate Chaos Mesh to GitHub Actions' },
        r = void 0,
        c = {},
        l = [
          { value: 'Design of chaos-mesh-action', id: 'design-of-chaos-mesh-action', level: 2 },
          {
            value: 'Use chaos-mesh-action in GitHub workflow',
            id: 'use-chaos-mesh-action-in-github-workflow',
            level: 2,
          },
          { value: 'Step 1: Design workflow', id: 'step-1-design-workflow', level: 3 },
          { value: 'Step 2: Create workflow', id: 'step-2-create-workflow', level: 3 },
          { value: 'Step 3: Run workflow', id: 'step-3-run-workflow', level: 3 },
      ...
      function h(e) {
        ...
        return (0, o.jsxs)(o.Fragment, {
          children: [
            ...
            (0, o.jsxs)(t.p, {
              children: [
                'chaos-mesh-action is a GitHub action that has been released on ',
                (0, o.jsx)(t.a, {
                  href: 'https://github.com/marketplace/actions/chaos-mesh',
                  children: 'GitHub Marketplace',
                }),
                '. Its source code is on ',
                (0, o.jsx)(t.a, { href: 'https://github.com/chaos-mesh/chaos-mesh-action', children: 'GitHub' }),
                ' as well.',
              ],
            }),
            '\n',
            (0, o.jsx)(t.h2, { id: 'design-of-chaos-mesh-action', children: 'Design of chaos-mesh-action' }),
            '\n',
            (0, o.jsxs)(t.p, {
              children: [
                (0, o.jsx)(t.a, { href: 'https://docs.github.com/en/actions', children: 'GitHub Action' }),
                ' is the continuous integration (CI) and continuous deployment (CD) feature natively supported by GitHub. Using GitHub Action, you can easily automate and customize software development workflows right in your repository with GitHub Actions.',
              ],
            }),
            '\n',
            (0, o.jsx)(t.p, {
            ...
            (0, o.jsx)(t.h2, {
              id: 'use-chaos-mesh-action-in-github-workflow',
              children: 'Use chaos-mesh-action in GitHub workflow',
            }),
            '\n',
            (0, o.jsx)(t.p, {
              children:
            ...
            (0, o.jsxs)(t.ul, {
              children: [
                '\n',
                (0, o.jsx)(t.li, { children: 'Step 1: Design workflow' }),
                '\n',
                (0, o.jsx)(t.li, { children: 'Step 2: Create workflow' }),
                '\n',
                (0, o.jsx)(t.li, { children: 'Step 3: Run workflow' }),
                '\n',
              ],
            }),
            '\n',
            (0, o.jsx)(t.h3, { id: 'step-1-design-workflow', children: 'Step 1: Design workflow' }),
            '\n',
            (0, o.jsx)(t.p, {
              children: 'Before designing a workflow, take the following questions into consideration:',
            }),
            '\n',
            (0, o.jsxs)(t.ul, {
              children: [
                '\n',
                (0, o.jsx)(t.li, { children: 'What features do you want to test in this workflow?' }),
                '\n',
                (0, o.jsx)(t.li, { children: 'What type of fault will be injected?' }),
                '\n',
                (0, o.jsx)(t.li, { children: 'How to verify the correctness of the system?' }),
                '\n',
              ],
            }),
            '\n',
            (0, o.jsx)(t.p, {
              children: 'For example, we can design a simple workflow for tests. The steps below can be included:',
            }),
            '\n',
            (0, o.jsxs)(t.ol, {
              children: [
                '\n',
                (0, o.jsx)(t.li, { children: 'Create two Pods in the Kubernetes cluster.' }),
                '\n',
                (0, o.jsx)(t.li, { children: 'Send ping request from one Pod to another Pod.' }),
                '\n',
                (0, o.jsx)(t.li, {
                  children:
            ...
            '\n',
            (0, o.jsx)(t.h3, { id: 'step-2-create-workflow', children: 'Step 2: Create workflow' }),
            '\n',
            (0, o.jsx)(t.p, {
              children: 'After the workflow is designed, take the following steps to create a workflow.',
            }),
            '\n',
            (0, o.jsxs)(t.ol, {
              children: [
                '\n',
                (0, o.jsx)(t.li, { children: 'Enter the GitHub repository of the software to be tested.' }),
                '\n',
                (0, o.jsxs)(t.li, {
                  children: [
                    'Create a workflow by clicking ',
                    (0, o.jsx)(t.code, { children: 'Actions' }),
                    ' and then click ',
                    (0, o.jsx)(t.code, { children: 'New workflow' }),
                    '.',
                  ],
                }),
                '\n',
            ...
            (0, o.jsxs)(t.ul, {
              children: [
                ...
                (0, o.jsxs)(t.li, {
                  children: [
                    '\n',
                    (0, o.jsx)(t.p, { children: 'Set the workflow name and the trigger rules.' }),
                    '\n',
                    (0, o.jsx)(t.p, {
                      children:
                ...
                (0, o.jsxs)(t.li, {
                  children: [
                    '\n',
                    (0, o.jsx)(t.p, { children: 'Install the CI-related environment.' }),
                    '\n',
                    (0, o.jsx)(t.p, {
                      children:
                ...
                (0, o.jsxs)(t.li, {
                  children: [
                    '\n',
                    (0, o.jsx)(t.p, { children: 'Deploy an application.' }),
                    '\n',
                    (0, o.jsx)(t.p, {
                      children:
                ...
                (0, o.jsxs)(t.li, {
                  children: [
                    '\n',
                    (0, o.jsx)(t.p, { children: 'Inject faults using Chaos Mesh.' }),
                    '\n',
                    (0, o.jsx)(t.pre, {
                      children: (0, o.jsx)(t.code, {
                        className: 'language-yaml',
                    ...
                    '\n',
                    (0, o.jsx)(t.pre, {
                      children: (0, o.jsx)(t.code, { className: 'language-bash', children: 'base64 chaos.yaml\n' }),
                    }),
                    '\n',
                  ],
                }),
                ...
                (0, o.jsxs)(t.li, {
                  children: [
                    '\n',
                    (0, o.jsx)(t.p, { children: 'Verify the correctness of the system.' }),
                    '\n',
                    (0, o.jsx)(t.p, {
                      children:
            ...
            '\n',
            (0, o.jsx)(t.h3, { id: 'step-3-run-workflow', children: 'Step 3: Run workflow' }),
            '\n',
            (0, o.jsx)(t.p, {
              children:
            ...
            (0, o.jsxs)(t.p, {
              children: [
                'Currently, chaos-mesh-action has been applied in ',
                (0, o.jsx)(t.a, { href: 'https://github.com/pingcap/tidb-operator', children: 'TiDB Operator' }),
                '. By injecting Pod faults into the workflow, you can verify the restart of the Operator instances. This is to ensure that the TiDB Operator can work properly when a Pod of TiDB operator is randomly deleted by the injected fault. For details, see the ',
                (0, o.jsx)(t.a, {
                  href: 'https://github.com/pingcap/tidb-operator/actions?query=workflow%3Achaos',
                  children: 'TiDB Operator Workflow page',
                }),
                '.',
              ],
            }),
            ...
            (0, o.jsxs)(t.p, {
              children: [
                'If you find any issue in chaos-mesh-action, or find any information is missing, you are welcome to create an ',
                (0, o.jsx)(t.a, { href: 'https://github.com/pingcap/chaos-mesh/issues', children: 'GitHub issue' }),
                ' or a ',
                (0, o.jsx)(t.a, {
                  href: 'https://github.com/chaos-mesh/chaos-mesh/pulls',
                  children: 'pull request (PR)',
                }),
                ' in the Chaos Mesh repository. You can also join our slack channel ',
                (0, o.jsx)(t.a, { href: 'https://slack.cncf.io/', children: '#project-chaos-mesh' }),
                ' in the ',
                (0, o.jsx)(t.a, { href: 'https://www.cncf.io/', children: 'CNCF' }),
                ' workspace.',
              ],
            }),
          ],
    ...
    76072: (e, t, n) => {
      n.d(t, { A: () => s })
      const s =
        n.p + 'assets/images/chaos-mesh-action-integrate-in-the-ci-workflow-c4fc76db3f8293ea144832cc24f3c232.png'
    },
    16931: (e, t, n) => {
      n.d(t, { A: () => s })
      const s = n.p + 'assets/images/creating-a-workflow-17c7622de0400b1cf0d0bd091a1c0561.png'
    },
    28453: (e, t, n) => {
      n.d(t, { R: () => a, x: () => r })
      var s = n(96540)
