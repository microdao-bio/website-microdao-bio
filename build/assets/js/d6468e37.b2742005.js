...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [6504],
  {
    47641: (e, s, t) => {
      ...
      const n = JSON.parse(
        '{"id":"define-chaos-experiment-scope","title":"Define the Scope of Chaos Experiments","description":"This document describes how to define the scope of a single Chaos experiment, which helps you accurately control the fault\'s explosion radius.","source":"@site/versioned_docs/version-2.6.2/define-chaos-experiment-scope.md","sourceDirName":".","slug":"/define-chaos-experiment-scope","permalink":"/docs/define-chaos-experiment-scope","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.6.2/define-chaos-experiment-scope.md","tags":[],"version":"2.6.2","frontMatter":{"title":"Define the Scope of Chaos Experiments"},"sidebar":"docs","previous":{"title":"Remote Cluster Management","permalink":"/docs/remote-cluster-management"},"next":{"title":"Define Scheduling Rules","permalink":"/docs/define-scheduling-rules"}}'
      )
      var i = t(74848),
        l = t(28453)
