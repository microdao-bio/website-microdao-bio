...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [1094],
  {
    80990: (e, n, a) => {
      ...
      const s = JSON.parse(
        '{"id":"configure-enabled-namespace","title":"Configure namespace for Chaos experiments","description":"This chapter walks you through how to configure Chaos experiments to only take effect in the specified namespace, and protect other unspecified namespaces against fault injection.","source":"@site/versioned_docs/version-2.5.2/configure-enabled-namespace.md","sourceDirName":".","slug":"/configure-enabled-namespace","permalink":"/docs/2.5.2/configure-enabled-namespace","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.5.2/configure-enabled-namespace.md","tags":[],"version":"2.5.2","frontMatter":{"title":"Configure namespace for Chaos experiments"},"sidebar":"docs","previous":{"title":"Manage User Permissions","permalink":"/docs/2.5.2/manage-user-permissions"},"next":{"title":"Remote Cluster Management","permalink":"/docs/2.5.2/remote-cluster-management"}}'
      )
      var t = a(74848),
        o = a(28453),
        i = a(13137)
      const r = { title: 'Configure namespace for Chaos experiments' },
        c = void 0,
        l = {},
        h = [
          {
          ...
          children: () => {
            const e = c(d, m),
              s = l
                ...
                ? n
                : n.replace(a, 'v' + e)
            return (0, r.jsx)(i.A, { className: h, children: s })
          },
        })
      }
    },
