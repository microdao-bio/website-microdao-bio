...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [36],
  {
    74375: (e, n, s) => {
      ...
      const o = JSON.parse(
        '{"id":"configure-development-environment","title":"Configure the Development Environment","description":"This document describes how to configure a local development environment for Chaos Mesh.","source":"@site/versioned_docs/version-2.5.2/configure-development-environment.md","sourceDirName":".","slug":"/configure-development-environment","permalink":"/docs/2.5.2/configure-development-environment","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.5.2/configure-development-environment.md","tags":[],"version":"2.5.2","frontMatter":{"title":"Configure the Development Environment"},"sidebar":"docs","previous":{"title":"Developer Guide Overview","permalink":"/docs/2.5.2/developer-guide-overview"},"next":{"title":"Add New Chaos Experiment Type","permalink":"/docs/2.5.2/add-new-chaos-experiment-type"}}'
      )
      var i = s(74848),
        r = s(28453)
