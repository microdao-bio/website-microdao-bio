...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [4530],
  {
          ...
          children: [
            ...
            (0, t.jsxs)(s.p, {
              children: [
                ...
                (0, t.jsx)(s.a, { href: '/docs/2.5.2/run-a-chaos-experiment', children: 'Run a Chaos experiment' }),
    ...
    77964: (e, s, n) => {
      ...
      const a = JSON.parse(
        '{"id":"production-installation-using-helm","title":"Install Chaos Mesh using Helm","description":"This document describes how to install Chaos Mesh in the production environment.","source":"@site/versioned_docs/version-2.5.2/production-installation-using-helm.md","sourceDirName":".","slug":"/production-installation-using-helm","permalink":"/docs/2.5.2/production-installation-using-helm","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.5.2/production-installation-using-helm.md","tags":[],"version":"2.5.2","frontMatter":{"title":"Install Chaos Mesh using Helm"},"sidebar":"docs","previous":{"title":"Quick Start","permalink":"/docs/2.5.2/quick-start"},"next":{"title":"Install Chaos Mesh Offline","permalink":"/docs/2.5.2/offline-installation"}}'
      )
      var t = n(74848),
        o = n(28453),
        r = n(11470),
          ...
          children: [
            ...
            (0, t.jsxs)(s.p, {
              children: [
                ...
                (0, t.jsx)(s.a, {
                  href: '/docs/2.5.2/persistence-dashboard',
