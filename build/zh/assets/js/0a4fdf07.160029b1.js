...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [4521],
  {
    58088: (e, s, n) => {
      ...
      const l = JSON.parse(
        '{"id":"chaosd-overview","title":"Chaosd \u7ec4\u4ef6\u7b80\u4ecb","description":"Chaosd \u7ec4\u4ef6\u7b80\u4ecb","source":"@site/i18n/zh/docusaurus-plugin-content-docs/current/chaosd-overview.md","sourceDirName":".","slug":"/chaosd-overview","permalink":"/zh/docs/next/chaosd-overview","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/i18n/zh/docusaurus-plugin-content-docs/current/chaosd-overview.md","tags":[],"version":"current","frontMatter":{"title":"Chaosd \u7ec4\u4ef6\u7b80\u4ecb"},"sidebar":"docs","previous":{"title":"Simulate Block Device Incidents","permalink":"/zh/docs/next/simulate-block-chaos-on-kubernetes"},"next":{"title":"\u4f7f\u7528 Chaos Mesh \u521b\u5efa\u7269\u7406\u673a\u6545\u969c","permalink":"/zh/docs/next/simulate-physical-machine-chaos"}}'
      )
      var c = n(74848),
        i = n(28453)
      ...
      function a(e) {
        ...
        return (0, c.jsxs)(c.Fragment, {
          children: [
            (0, c.jsx)(s.h2, { id: 'chaosd-\u7ec4\u4ef6\u7b80\u4ecb', children: 'Chaosd \u7ec4\u4ef6\u7b80\u4ecb' }),
            '\n',
            (0, c.jsxs)(s.p, {
              children: [
                (0, c.jsx)(s.a, { href: 'https://github.com/chaos-mesh/chaosd', children: 'Chaosd' }),
            ...
            '\n',
            (0, c.jsx)(s.p, { children: 'Chaosd \u5177\u6709\u4ee5\u4e0b\u6838\u5fc3\u4f18\u52bf\uff1a' }),
            '\n',
            (0, c.jsxs)(s.ul, {
              children: [
                '\n',
            ...
            '\n',
            (0, c.jsx)(s.h3, { id: '\u8fd0\u884c\u73af\u5883', children: '\u8fd0\u884c\u73af\u5883' }),
            '\n',
            (0, c.jsx)(s.p, { children: 'glibc \u5fc5\u987b\u4e3a 2.17 \u53ca\u4ee5\u4e0a\u7248\u672c\u3002' }),
            '\n',
            (0, c.jsx)(s.h3, { id: '\u4e0b\u8f7d\u548c\u90e8\u7f72', children: '\u4e0b\u8f7d\u548c\u90e8\u7f72' }),
            '\n',
            (0, c.jsxs)(s.ol, {
              children: [
                '\n',
                (0, c.jsxs)(s.li, {
                  children: [
                    ...
                    (0, c.jsxs)(s.p, {
                      children: [
                        '\u5982\u679c\u8981\u4e0b\u8f7d\u6700\u65b0\u7684\u975e\u7a33\u5b9a\u7248\u672c\uff0c\u5219\u4f7f\u7528 ',
                        (0, c.jsx)(s.code, { children: 'latest' }),
                        '\uff1a',
                      ],
                    }),
                    '\n',
                ...
                (0, c.jsxs)(s.li, {
                  children: [
                    '\n',
                    (0, c.jsx)(s.p, { children: '\u4e0b\u8f7d Chaosd\uff1a' }),
                    '\n',
                    (0, c.jsx)(s.pre, {
                      children: (0, c.jsx)(s.code, {
                        className: 'language-bash',
            ...
            '\n',
            (0, c.jsx)(s.h3, { id: '\u8fd0\u884c\u6a21\u5f0f', children: '\u8fd0\u884c\u6a21\u5f0f' }),
            '\n',
            (0, c.jsx)(s.p, {
      ...
      function t(e = {}) {
        ...
        return s ? (0, c.jsx)(s, { ...e, children: (0, c.jsx)(a, { ...e }) }) : a(e)
      }
    },
    28453: (e, s, n) => {
      n.d(s, { R: () => d, x: () => h })
