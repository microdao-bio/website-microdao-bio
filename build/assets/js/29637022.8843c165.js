...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [3580],
  {
    49927: (e, t, n) => {
      ...
      const o = JSON.parse(
        '{"id":"gcp-authentication","title":"GCP OAuth Authentication","description":"When Chaos Mesh is deployed on the Google Cloud Platform, you can log in to Chaos Dashboard through Google OAuth. This document describes how to enable and configure this function.","source":"@site/docs/gcp-authentication.md","sourceDirName":".","slug":"/gcp-authentication","permalink":"/docs/next/gcp-authentication","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/docs/gcp-authentication.md","tags":[],"version":"current","frontMatter":{"title":"GCP OAuth Authentication"},"sidebar":"docs","previous":{"title":"Search and Recover Experiments of Chaosd","permalink":"/docs/next/chaosd-search-recover"},"next":{"title":"Integrate Chaos Mesh to GitHub Actions","permalink":"/docs/next/integrate-chaos-mesh-into-github-actions"}}'
      )
      var s = n(74848),
        i = n(28453)
      ...
      function l(e) {
        ...
        return (0, s.jsxs)(s.Fragment, {
          children: [
            ...
            '\n',
            (0, s.jsx)(t.p, {
              children: (0, s.jsx)(t.img, { alt: 'img', src: n(45093).A + '', width: '640', height: '855' }),
            }),
            '\n',
            (0, s.jsx)(t.p, {
              children:
