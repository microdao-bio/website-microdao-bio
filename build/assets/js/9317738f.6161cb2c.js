...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [4991],
  {
    97138: (e, s, t) => {
      ...
      const n = JSON.parse(
        '{"id":"create-chaos-mesh-workflow","title":"Create Chaos Mesh Workflow","description":"Introduction to Chaos Mesh Workflow","source":"@site/docs/create-chaos-mesh-workflow.md","sourceDirName":".","slug":"/create-chaos-mesh-workflow","permalink":"/docs/next/create-chaos-mesh-workflow","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/docs/create-chaos-mesh-workflow.md","tags":[],"version":"current","frontMatter":{"title":"Create Chaos Mesh Workflow"},"sidebar":"docs","previous":{"title":"Inspect Results of Chaos Experiments","permalink":"/docs/next/inspect-chaos-experiments"},"next":{"title":"Serial and Parallel Experiments","permalink":"/docs/next/run-serial-or-parallel-experiments"}}'
      )
      var i = t(74848),
        o = t(28453)
      ...
      function c(e) {
        ...
        return (0, i.jsxs)(i.Fragment, {
          children: [
            ...
            '\n',
            (0, i.jsx)(s.p, {
              children: (0, i.jsx)(s.img, { alt: 'New Workflow', src: t(22405).A + '', width: '800', height: '404' }),
            }),
            '\n',
            (0, i.jsx)(s.h3, {
              id: 'step-2-setup-basic-information-of-the-workflow',
            ...
            '\n',
            (0, i.jsx)(s.p, {
              children: (0, i.jsx)(s.img, { alt: 'Workflow Info', src: t(57301).A + '', width: '572', height: '422' }),
            }),
            '\n',
            (0, i.jsx)(s.h3, {
              id: 'step-3-configure-the-nodes-of-the-workflow',
                      ...
                      children: [
                        ...
                        (0, i.jsxs)(s.td, {
                          children: [
                            ...
                            '. See the ',
                            (0, i.jsx)(s.a, { href: '/docs/next/simulate-aws-chaos', children: 'Simulate AWS Faults' }),
                      ...
                      children: [
                        ...
                        (0, i.jsxs)(s.td, {
                          children: [
                            ...
                            '.See the ',
                            (0, i.jsx)(s.a, {
                              href: '/docs/next/simulate-gcp-chaos',
                      ...
                      children: [
                        ...
                        (0, i.jsxs)(s.td, {
                          children: [
                            ...
                            '. See the ',
                            (0, i.jsx)(s.a, {
                              href: '/docs/next/status-check-in-workflow',
