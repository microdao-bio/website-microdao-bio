...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [3530],
  {
    36870: (e, s, n) => {
      ...
      const o = JSON.parse(
        '{"id":"chaosd-overview","title":"Chaosd Introduction","description":"Chaosd introduction","source":"@site/versioned_docs/version-2.5.2/chaosd-overview.md","sourceDirName":".","slug":"/chaosd-overview","permalink":"/docs/2.5.2/chaosd-overview","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.5.2/chaosd-overview.md","tags":[],"version":"2.5.2","frontMatter":{"title":"Chaosd Introduction"},"sidebar":"docs","previous":{"title":"Simulate Block Device Latency","permalink":"/docs/2.5.2/simulate-block-chaos-on-kubernetes"},"next":{"title":"Simulate Faults on Physical Machines","permalink":"/docs/2.5.2/simulate-physical-machine-chaos"}}'
      )
      var t = n(74848),
        i = n(28453)
      const a = { title: 'Chaosd Introduction' },
        r = void 0,
        d = {},
        l = [
          { value: 'Chaosd introduction', id: 'chaosd-introduction', level: 2 },
          { value: 'Supported fault types', id: 'supported-fault-types', level: 3 },
          { value: 'Operating environment', id: 'operating-environment', level: 3 },
          { value: 'Download and deploy', id: 'download-and-deploy', level: 3 },
          { value: 'Work modes', id: 'work-modes', level: 3 },
        ]
      function c(e) {
        const s = {
          a: 'a',
        ...
        return (0, t.jsxs)(t.Fragment, {
          children: [
            (0, t.jsx)(s.h2, { id: 'chaosd-introduction', children: 'Chaosd introduction' }),
            '\n',
            (0, t.jsxs)(s.p, {
              children: [
                (0, t.jsx)(s.a, { href: 'https://github.com/chaos-mesh/chaosd', children: 'Chaosd' }),
                ' is a Chaos Engineering testing tool provided by Chaos Mesh. You need to download and deploy it separately (see ',
                (0, t.jsx)(s.a, { href: '#download-and-deploy', children: 'Download and deploy' }),
                '). It is used to inject faults into physical machine environments and also recover faults.',
              ],
            }),
            '\n',
            ...
            (0, t.jsxs)(s.ul, {
              children: [
                ...
                '\n',
                (0, t.jsx)(s.li, {
                  children: 'Pressure: Injects pressure on the CPU or memory of the physical machines.',
                }),
                '\n',
                (0, t.jsx)(s.li, {
                  children:
              ...
              children: [
                ...
                (0, t.jsxs)(s.li, {
                  children: [
                    ...
                    (0, t.jsxs)(s.p, {
                      children: [
                        'To view all released versions of Chaosd, refer to ',
                        (0, t.jsx)(s.a, {
                    ...
                    (0, t.jsxs)(s.p, {
                      children: [
                        ...
                        (0, t.jsx)(s.code, { children: 'latest' }),
                        ':',
                      ],
                    }),
                    '\n',
                ...
                (0, t.jsxs)(s.li, {
                  children: [
                    ...
                    (0, t.jsxs)(s.p, {
                      children: [
                        'Unzip the Chaosd file and move it to the ',
                        (0, t.jsx)(s.code, { children: '/usr/local' }),
                        ' directory:',
                      ],
                    }),
                    '\n',
                ...
                (0, t.jsxs)(s.li, {
                  children: [
                    ...
                    (0, t.jsxs)(s.p, {
                      children: [
                        'Add the Chaosd directory to the ',
                        (0, t.jsx)(s.code, { children: 'PATH' }),
