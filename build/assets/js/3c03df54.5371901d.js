...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [2603],
  {
    75121: (e, t, n) => {
      ...
      const s = JSON.parse(
        '{"id":"simulate-network-chaos-in-physical-nodes","title":"Simulate Network Faults","description":"This document introduces how to use Chaosd to simulate network faults. The simulations can be completed by modifying network routing and traffic flow control using iptables, ipsets, tc, etc.","source":"@site/versioned_docs/version-2.4.3/simulate-network-chaos-in-physical-nodes.md","sourceDirName":".","slug":"/simulate-network-chaos-in-physical-nodes","permalink":"/docs/2.4.3/simulate-network-chaos-in-physical-nodes","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.4.3/simulate-network-chaos-in-physical-nodes.md","tags":[],"version":"2.4.3","frontMatter":{"title":"Simulate Network Faults"},"sidebar":"docs","previous":{"title":"Simulate Process Faults","permalink":"/docs/2.4.3/simulate-process-chaos-in-physical-nodes"},"next":{"title":"Simulate Host Faults","permalink":"/docs/2.4.3/simulate-host-console-in-physical-nodes"}}'
      )
      var i = n(74848),
        r = n(28453)
