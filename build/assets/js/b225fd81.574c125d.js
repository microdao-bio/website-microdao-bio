...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [3111],
  {
    4637: (e, n, s) => {
      ...
      const o = JSON.parse(
        '{"id":"configure-development-environment","title":"Configure the Development Environment","description":"This document describes how to configure a local development environment for Chaos Mesh.","source":"@site/versioned_docs/version-2.6.2/configure-development-environment.md","sourceDirName":".","slug":"/configure-development-environment","permalink":"/docs/configure-development-environment","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.6.2/configure-development-environment.md","tags":[],"version":"2.6.2","frontMatter":{"title":"Configure the Development Environment"},"sidebar":"docs","previous":{"title":"Developer Guide Overview","permalink":"/docs/developer-guide-overview"},"next":{"title":"Add a New Chaos Experiment Type","permalink":"/docs/add-new-chaos-experiment-type"}}'
      )
      var i = s(74848),
        r = s(28453)
      const t = { title: 'Configure the Development Environment' },
        a = void 0,
        l = {},
        c = [
      ...
      function h(e) {
        ...
        return (0, i.jsxs)(i.Fragment, {
          children: [
            ...
            (0, i.jsxs)(n.p, {
              children: [
                'Most components of Chaos Mesh are ',
                (0, i.jsx)(n.strong, { children: 'only designed for Linux' }),
                ', so we suggest that you also configure your development environment to run on Linux. For example, use a virtual machine or WSL 2 and use VSCode Remote as your editor.',
              ],
            }),
            '\n',
            (0, i.jsx)(n.p, {
              ...
              children: [
                ...
                (0, i.jsxs)(n.li, {
                  children: [
                    ...
                    ', ',
                    (0, i.jsx)(n.code, { children: 'v3.9.0' }),
                    ' or later versions',
                  ],
                }),
                '\n',
              ...
              children: [
                ...
                (0, i.jsxs)(n.li, {
                  children: [
                    ...
                    ' and ',
                    (0, i.jsx)(n.a, { href: 'https://pnpm.io/', children: 'pnpm' }),
              ...
              children: [
                ...
                (0, i.jsxs)(n.li, {
                  children: [
                    ...
                    '\n',
                    (0, i.jsx)(n.pre, {
                      children: (0, i.jsx)(n.code, { className: 'language-bash', children: 'UI=1 make image\n' }),
                    }),
                    '\n',
                    (0, i.jsx)(n.admonition, {
                      type: 'tip',
                      children: (0, i.jsxs)(n.p, {
                        children: [
                          (0, i.jsx)(n.code, { children: 'UI=1' }),
                          " means that we will compile the user interface of Chaos Dashboard, if you don't need it, you can omit this env.",
                        ],
                      }),
                    }),
                    '\n',
                    (0, i.jsx)(n.admonition, {
                      ...
                      children: (0, i.jsxs)(n.p, {
                        children: [
                          ...
                          (0, i.jsx)(n.code, { children: 'UI=1 make IMAGE_TAG=dev image' }),
                          '.',
                        ],
                      }),
                    }),
              ...
              children: [
                ...
                (0, i.jsxs)(n.li, {
                  children: [
                    '\n',
                    (0, i.jsxs)(n.p, {
                      children: ['Compile Chaos Mesh with ', (0, i.jsx)(n.code, { children: 'DEBUGGER=1' }), ':'],
                    }),
                    '\n',
                    (0, i.jsx)(n.pre, {
                      children: (0, i.jsx)(n.code, {
                        className: 'language-bash',
                        children: 'UI=1 DEBUGGER=1 make image\n',
                      }),
                    }),
                    '\n',
                  ],
                      ...
                      children: [
                        (0, i.jsxs)(n.p, {
                          children: [
                            ...
                            ' feature by default and will create 3 replicas for ',
                            (0, i.jsx)(n.code, { children: 'chaos-controller-manager' }),
                            '. We will use ',
                            (0, i.jsx)(n.code, { children: 'controllerManager.leaderElection.enabled=false' }),
                            ' to ensure that Chaos Mesh only creates 1 instance of ',
                            (0, i.jsx)(n.code, { children: 'chaos-controller-manager' }),
                        ...
                        (0, i.jsxs)(n.p, {
                          children: [
                            ...
                            (0, i.jsx)(n.a, {
                              href: '/docs/production-installation-using-helm#step-4-install-chaos-mesh-in-different-environments',
                              children: 'Install Chaos Mesh in different environments',
                            }),
                            '.',
                          ],
                        }),
                  ...
                  children: [
                    ...
                    (0, i.jsxs)(n.p, {
                      children: [
                        ...
                        ' to forward the delve debugging server to a local port.',
                      ],
                    }),
                    '\n',
                    (0, i.jsxs)(n.p, {
            ...
            (0, i.jsxs)(n.h3, {
              ...
              children: [
                'Run make fail with ',
                (0, i.jsx)(n.code, { children: 'error obtaining VCS status: exit status 128' }),
                ' in MacOS',
              ],
            }),
            '\n',
            (0, i.jsxs)(n.p, {
              children: [
                ...
                (0, i.jsx)(n.a, {
                  href: 'https://github.blog/2022-04-12-git-security-vulnerability-announced/',
                  children: 'https://github.blog/2022-04-12-git-security-vulnerability-announced/',
                }),
                ". It's recommended you to read it first.",
              ],
            }),
            '\n',
            (0, i.jsxs)(n.p, {
              children: [
                'Chaos Mesh will start the container (',
                (0, i.jsx)(n.code, { children: 'dev-env' }),
                ' or ',
                (0, i.jsx)(n.code, { children: 'build-env' }),
                ') with the current user (when you call ',
                (0, i.jsx)(n.code, { children: 'make' }),
                '). You can find the appropriate ',
                (0, i.jsx)(n.code, { children: '--user' }),
                ' flag in ',
                (0, i.jsx)(n.a, {
                  href: 'https://github.com/chaos-mesh/chaos-mesh/blob/813b650c02e0b065ae5c4707725c346929ab1847/build/get_env_shell.py#L81C10-L81C10',
                  children: 'get_env_shell.py#L81C10-L81C10',
                }),
                '. So when Git is looking for a top-level ',
            ...
            (0, i.jsxs)(n.p, {
              children: [
                'A temporary solution for now is to comment out the line of ',
                (0, i.jsx)(n.code, { children: '--user' }),
                '.',
              ],
            }),
