...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [9379],
  {
    39685: (e, s, n) => {
      ...
      const t = JSON.parse(
        '{"id":"simulate-dns-chaos-on-kubernetes","title":"Simulate DNS Faults","description":"This document describes how to create DNSChaos experiments in Chaos Mesh to simulate DNS faults.","source":"@site/versioned_docs/version-2.6.2/simulate-dns-chaos-on-kubernetes.md","sourceDirName":".","slug":"/simulate-dns-chaos-on-kubernetes","permalink":"/docs/simulate-dns-chaos-on-kubernetes","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.6.2/simulate-dns-chaos-on-kubernetes.md","tags":[],"version":"2.6.2","frontMatter":{"title":"Simulate DNS Faults"},"sidebar":"docs","previous":{"title":"Simulate File I/O Faults","permalink":"/docs/simulate-io-chaos-on-kubernetes"},"next":{"title":"Simulate Time Faults","permalink":"/docs/simulate-time-chaos-on-kubernetes"}}'
      )
      var i = n(74848),
        r = n(28453),
        l = n(13137)
        ...
        return (0, i.jsxs)(i.Fragment, {
          children: [
            ...
            (0, i.jsxs)(s.admonition, {
              ...
              children: [
                (0, i.jsx)(s.p, {
                  children: 'To simluate DNS faults, you need to deploy a special DNS service called Chaos DNS Server.',
                }),
                (0, i.jsxs)(s.p, {
                  children: [
                    "In the latest version, Chaos Mesh will deploy Chaos DNS Server by default. If you don't need to simulate DNS faults, you can set ",
                    (0, i.jsx)(s.code, { children: 'dnsServer.create' }),
                    ' to ',
                    (0, i.jsx)(s.code, { children: 'false' }),
                    ' when installing Chaos Mesh:',
                  ],
                }),
                (0, i.jsx)(l.A, {
                  children:
            ...
            '\n',
            (0, i.jsx)(s.h2, {
              id: 'check-if-chaos-dns-server-is-deployed',
              children: 'Check if Chaos DNS Server is deployed',
            }),
            '\n',
            (0, i.jsx)(s.p, { children: 'Check if Chaos DNS Server is deployed by running the following command:' }),
            '\n',
            (0, i.jsx)(s.pre, {
