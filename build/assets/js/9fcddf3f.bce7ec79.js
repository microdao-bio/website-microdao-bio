...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [7870],
  {
    72531: (e, t, n) => {
      ...
      const s = JSON.parse(
        '{"id":"simulate-network-chaos-in-physical-nodes","title":"Simulate Network Faults","description":"This document introduces how to use Chaosd to simulate network faults. The simulations can be completed by modifying network routing and traffic flow control using iptables, ipsets, tc, etc.","source":"@site/docs/simulate-network-chaos-in-physical-nodes.md","sourceDirName":".","slug":"/simulate-network-chaos-in-physical-nodes","permalink":"/docs/next/simulate-network-chaos-in-physical-nodes","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/docs/simulate-network-chaos-in-physical-nodes.md","tags":[],"version":"current","frontMatter":{"title":"Simulate Network Faults"},"sidebar":"docs","previous":{"title":"Simulate Process Faults","permalink":"/docs/next/simulate-process-chaos-in-physical-nodes"},"next":{"title":"Simulate Host Faults","permalink":"/docs/next/simulate-host-console-in-physical-nodes"}}'
      )
      var i = n(74848),
        r = n(28453)
