...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [4820],
  {
    36: (e, s, n) => {
      ...
      const o = JSON.parse(
        '{"id":"overview","title":"Chaos Mesh \u7b80\u4ecb","description":"\u672c\u7bc7\u6587\u6863\u63cf\u8ff0 Chaos Mesh \u7684\u6982\u5ff5\u3001\u4f7f\u7528\u573a\u666f\u3001\u6838\u5fc3\u4f18\u52bf\u3001\u4ee5\u53ca\u67b6\u6784\u6982\u89c8\u3002","source":"@site/i18n/zh/docusaurus-plugin-content-docs/version-2.5.2/overview.md","sourceDirName":".","slug":"/","permalink":"/zh/docs/2.5.2/","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/i18n/zh/docusaurus-plugin-content-docs/version-2.5.2/overview.md","tags":[],"version":"2.5.2","frontMatter":{"slug":"/","title":"Chaos Mesh \u7b80\u4ecb"},"sidebar":"docs","next":{"title":"\u57fa\u672c\u529f\u80fd","permalink":"/zh/docs/2.5.2/basic-features"}}'
      )
      var r = n(74848),
        h = n(28453)
      const t = { slug: '/', title: 'Chaos Mesh \u7b80\u4ecb' },
        i = void 0,
        l = {},
        a = [
          { value: '\u7b80\u4ecb', id: '\u7b80\u4ecb', level: 2 },
          {
            value: 'Chaos Mesh \u7684\u6838\u5fc3\u4f18\u52bf',
            id: 'chaos-mesh-\u7684\u6838\u5fc3\u4f18\u52bf',
            level: 2,
          },
      ...
      function c(e) {
        ...
        return (0, r.jsxs)(r.Fragment, {
          children: [
            ...
            '\n',
            (0, r.jsx)(s.h2, { id: '\u7b80\u4ecb', children: '\u7b80\u4ecb' }),
            '\n',
            (0, r.jsx)(s.p, {
              children:
            ...
            (0, r.jsxs)(s.ul, {
              children: [
                ...
                (0, r.jsxs)(s.li, {
                  children: [
                    '\u6838\u5fc3\u80fd\u529b\u7a33\u56fa\uff1aChaos Mesh \u8d77\u6e90\u4e8e ',
                    (0, r.jsx)(s.a, { href: 'https://github.com/pingcap/tidb', children: 'TiDB' }),
                    ' \u7684\u6838\u5fc3\u6d4b\u8bd5\u5e73\u53f0\uff0c\u53d1\u5e03\u521d\u671f\u5373\u7ee7\u627f\u4e86\u5927\u91cf TiDB \u5df2\u6709\u7684\u6d4b\u8bd5\u7ecf\u9a8c\u3002',
                  ],
                }),
                '\n',
                (0, r.jsx)(s.li, {
            ...
            '\n',
            (0, r.jsx)(s.h2, { id: '\u67b6\u6784\u6982\u89c8', children: '\u67b6\u6784\u6982\u89c8' }),
            '\n',
            (0, r.jsx)(s.p, {
              children:
            ...
            (0, r.jsxs)(s.ul, {
              children: [
                ...
                (0, r.jsxs)(s.li, {
                  children: [
                    (0, r.jsx)(s.strong, { children: 'Chaos Dashboard' }),
                    '\uff1aChaos Mesh \u7684\u53ef\u89c6\u5316\u7ec4\u4ef6\uff0c\u63d0\u4f9b\u4e86\u4e00\u5957\u7528\u6237\u53cb\u597d\u7684 Web \u754c\u9762\uff0c\u7528\u6237\u53ef\u901a\u8fc7\u8be5\u754c\u9762\u5bf9\u6df7\u6c8c\u5b9e\u9a8c\u8fdb\u884c\u64cd\u4f5c\u548c\u89c2\u6d4b\u3002\u540c\u65f6\uff0cChaos Dashboard \u8fd8\u63d0\u4f9b\u4e86 RBAC \u6743\u9650\u7ba1\u7406\u673a\u5236\u3002',
                  ],
                }),
                '\n',
                (0, r.jsxs)(s.li, {
                  children: [
                    (0, r.jsx)(s.strong, { children: 'Chaos Controller Manager' }),
                    '\uff1aChaos Mesh \u7684\u6838\u5fc3\u903b\u8f91\u7ec4\u4ef6\uff0c\u4e3b\u8981\u8d1f\u8d23\u6df7\u6c8c\u5b9e\u9a8c\u7684\u8c03\u5ea6\u4e0e\u7ba1\u7406\u3002\u8be5\u7ec4\u4ef6\u5305\u542b\u591a\u4e2a CRD Controller\uff0c\u4f8b\u5982 Workflow Controller\u3001Scheduler Controller \u4ee5\u53ca\u5404\u7c7b\u6545\u969c\u7c7b\u578b\u7684 Controller\u3002',
                  ],
                }),
                '\n',
                (0, r.jsxs)(s.li, {
                  children: [
                    (0, r.jsx)(s.strong, { children: 'Chaos Daemon' }),
                    '\uff1aChaos Mesh \u7684\u4e3b\u8981\u6267\u884c\u7ec4\u4ef6\u3002Chaos Daemon \u4ee5 ',
                    (0, r.jsx)(s.a, {
                      href: 'https://kubernetes.io/docs/concepts/workloads/controllers/daemonset/',
                      children: 'DaemonSet',
                    }),
                    ' \u7684\u65b9\u5f0f\u8fd0\u884c\uff0c\u9ed8\u8ba4\u62e5\u6709 Privileged \u6743\u9650\uff08\u53ef\u4ee5\u5173\u95ed\uff09\u3002\u8be5\u7ec4\u4ef6\u4e3b\u8981\u901a\u8fc7\u4fb5\u5165\u76ee\u6807 Pod Namespace \u7684\u65b9\u5f0f\u5e72\u6270\u5177\u4f53\u7684\u7f51\u7edc\u8bbe\u5907\u3001\u6587\u4ef6\u7cfb\u7edf\u3001\u5185\u6838\u7b49\u3002',
                  ],
                }),
                '\n',
              ],
            ...
            '\n',
            (0, r.jsx)(s.p, {
              children: (0, r.jsx)(s.img, { alt: 'Architecture', src: n(89792).A + '', width: '751', height: '922' }),
            }),
            '\n',
            (0, r.jsx)(s.p, {
              children:
    ...
    89792: (e, s, n) => {
      n.d(s, { A: () => o })
      const o = n.p + 'assets/images/architecture-76301820de324f79d79db310b11b9246.png'
    },
    28453: (e, s, n) => {
      n.d(s, { R: () => t, x: () => i })
      var o = n(96540)
        ...
        return (
          (s = e.disableParentContext
            ? 'function' == typeof e.components
              ...
              : e.components || r
            : t(e.components)),
          o.createElement(h.Provider, { value: s }, e.children)
        )
      }
    },
  },
