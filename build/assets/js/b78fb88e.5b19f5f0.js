...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [1164],
  {
    2370: (e, n, t) => {
      ...
      const i = JSON.parse(
        '{"id":"simulate-network-chaos-on-kubernetes","title":"Simulate Network Faults","description":"This document describes how to simulate network faults using NetworkChaos in Chaos Mesh.","source":"@site/versioned_docs/version-2.6.2/simulate-network-chaos-on-kubernetes.md","sourceDirName":".","slug":"/simulate-network-chaos-on-kubernetes","permalink":"/docs/simulate-network-chaos-on-kubernetes","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.6.2/simulate-network-chaos-on-kubernetes.md","tags":[],"version":"2.6.2","frontMatter":{"title":"Simulate Network Faults"},"sidebar":"docs","previous":{"title":"Simulate Pod Faults","permalink":"/docs/simulate-pod-chaos-on-kubernetes"},"next":{"title":"Simulate Stress Scenarios","permalink":"/docs/simulate-heavy-stress-on-kubernetes"}}'
      )
      var s = t(74848),
        r = t(28453)
                  ...
                  children: [
                    (0, s.jsxs)(n.tr, {
                      children: [
                        ...
                        (0, s.jsx)(n.td, { children: 'string' }),
                        (0, s.jsx)(n.td, { children: 'Indicates the rate of bandwidth limit' }),
                        (0, s.jsx)(n.td, {}),
                        (0, s.jsx)(n.td, { children: 'Yes' }),
