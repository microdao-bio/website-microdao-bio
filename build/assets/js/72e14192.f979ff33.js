...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [2814, 6605, 7905],
  {
          ...
          children: [
            ...
            (0, i.jsxs)(n.p, {
              children: [
                ...
                (0, i.jsx)(n.a, { href: '/docs/next/run-a-chaos-experiment', children: 'Run a Chaos experiment' }),
    ...
    81953: (e, n, t) => {
      ...
      const s = JSON.parse(
        '{"id":"quick-start","title":"Quick Start","description":"This document describes how to start Chaos Mesh quickly in a test or local environment.","source":"@site/docs/quick-start.md","sourceDirName":".","slug":"/quick-start","permalink":"/docs/next/quick-start","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/docs/quick-start.md","tags":[],"version":"current","frontMatter":{"title":"Quick Start"},"sidebar":"docs","previous":{"title":"Basic Features","permalink":"/docs/next/basic-features"},"next":{"title":"Install Chaos Mesh using Helm","permalink":"/docs/next/production-installation-using-helm"}}'
      )
      var i = t(74848),
        o = t(28453),
        r = t(34661),
          ...
          children: () => {
            const e = a(d, u),
              s = l
                ...
                ? n
                : n.replace(t, 'v' + e)
            return (0, c.jsx)(r.A, { className: h, children: s })
          },
        })
      }
    },
