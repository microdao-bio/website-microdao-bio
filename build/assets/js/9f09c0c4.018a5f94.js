...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [607],
  {
    40199: (e, n, o) => {
      ...
      const s = JSON.parse(
        '{"id":"extend-chaos-daemon-interface","title":"Extend Chaos Daemon Interface","description":"In Add new chaos experiment type, you have added HelloWorldChaos, which can print Hello World! in the logs of Chaos Controller Manager. To enable the HelloWorldChaos to inject some faults into the target Pod, you need to extend interface for Chaos Daemon.","source":"@site/versioned_docs/version-2.4.3/extend-chaos-daemon-interface.md","sourceDirName":".","slug":"/extend-chaos-daemon-interface","permalink":"/docs/2.4.3/extend-chaos-daemon-interface","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.4.3/extend-chaos-daemon-interface.md","tags":[],"version":"2.4.3","frontMatter":{"title":"Extend Chaos Daemon Interface"},"sidebar":"docs","previous":{"title":"Add New Chaos Experiment Type","permalink":"/docs/2.4.3/add-new-chaos-experiment-type"},"next":{"title":"Extend Chaosd","permalink":"/docs/2.4.3/extend-chaosd"}}'
      )
      var r = o(74848),
        t = o(28453),
        a = o(13137)
      const l = { title: 'Extend Chaos Daemon Interface' },
        c = void 0,
        i = {},
        h = [
          ...
          children: [
            (0, r.jsxs)(n.p, {
              children: [
                ...
                ', you have added HelloWorldChaos, which can print ',
                (0, r.jsx)(n.code, { children: 'Hello World!' }),
                ' in the logs of Chaos Controller Manager. To enable the HelloWorldChaos to inject some faults into the target Pod, you need to extend interface for Chaos Daemon.',
              ],
            }),
            '\n',
            (0, r.jsx)(n.admonition, {
              ...
              children: (0, r.jsxs)(n.p, {
                children: [
                  ...
                  (0, r.jsx)(n.a, {
                    href: '/docs/2.4.3/#architecture-overview',
                    children: 'the architecture of Chaos Mesh',
                  }),
              ...
              children: [
                ...
                (0, r.jsx)(n.li, {
                  children: (0, r.jsx)(n.a, {
                    href: '#implement-the-grpc-interface',
                    children: 'Implement the gRPC interface',
                  }),
                }),
                '\n',
                (0, r.jsx)(n.li, {
                  children: (0, r.jsx)(n.a, { href: '#verify-the-experiment', children: 'Verify the experiment' }),
                }),
                '\n',
            ...
            (0, r.jsxs)(n.p, {
              children: [
                'In ',
                (0, r.jsx)(n.code, { children: 'api/v1alpha1/helloworldchaos_type.go' }),
                ', you have defined ',
                (0, r.jsx)(n.code, { children: 'HelloWorldSpec' }),
                ', which includes ',
                (0, r.jsx)(n.code, { children: 'ContainerSelector' }),
                ':',
              ],
            }),
            '\n',
              ...
              children: [
                ...
                (0, r.jsxs)(n.li, {
                  children: [
                    ...
                    (0, r.jsxs)(n.p, {
                      children: [
                        'Add the RPC in ',
                        (0, r.jsx)(n.code, { children: 'pkg/chaosdaemon/pb/chaosdaemon.proto' }),
                        ':',
                      ],
                    }),
                    '\n',
                    ...
                    '\n',
                    (0, r.jsx)(n.p, { children: 'You need to update the Golang code generated by this proto file:' }),
                    '\n',
                    (0, r.jsx)(n.pre, {
                      children: (0, r.jsx)(n.code, { className: 'language-bash', children: 'make proto\n' }),
                    }),
                    '\n',
                  ],
                }),
                ...
                (0, r.jsxs)(n.li, {
                  children: [
                    ...
                    (0, r.jsxs)(n.p, {
                      children: [
                        'In the ',
                        (0, r.jsx)(n.code, { children: 'pkg/chaosdaemon' }),
                        ' directory, create a file named ',
                        (0, r.jsx)(n.code, { children: 'helloworld_server.go' }),
                    ...
                    (0, r.jsxs)(n.p, {
                      children: [
                        'After ',
                        (0, r.jsx)(n.code, { children: 'chaos-daemon' }),
                        ' receives the ',
                        (0, r.jsx)(n.code, { children: 'ExecHelloWorldChaos' }),
                ...
                (0, r.jsxs)(n.li, {
                  children: [
                    ...
                    (0, r.jsxs)(n.p, {
                      children: [
                        'Each chaos experiment has its life cycle: ',
                        (0, r.jsx)(n.code, { children: 'apply' }),
                        ' and then ',
                        (0, r.jsx)(n.code, { children: 'recover' }),
                        '. However, there are some chaos experiments that cannot be recovered by default (for example, PodKill in PodChaos, and HelloWorldChaos). These are called OneShot experiments. You can find ',
                        (0, r.jsx)(n.code, { children: '+chaos-mesh:oneshot=true' }),
                        ' in the file that defines the schema type of chaos experiment type.',
                      ],
                    }),
                    '\n',
                    (0, r.jsxs)(n.p, {
                      children: [
                        'Chaos Controller Manager needs to send a request to Chaos Daemon when HelloWorldChaos is in ',
                        (0, r.jsx)(n.code, { children: 'recover' }),
                        '. To do this, you need to modify ',
                        (0, r.jsx)(n.code, { children: 'controllers/chaosimpl/helloordchaos/types.go' }),
                        ':',
                      ],
                    }),
                    '\n',
            ...
            '\n',
            (0, r.jsx)(n.h2, { id: 'verify-the-experiment', children: 'Verify the experiment' }),
            '\n',
            (0, r.jsx)(n.p, { children: 'To verify the experiment, perform the following steps.' }),
            '\n',
            (0, r.jsxs)(n.ol, {
              children: [
                '\n',
                ...
                (0, r.jsxs)(n.li, {
                  children: [
                    ...
                    '\n',
                    (0, r.jsx)(a.A, {
                      children: 'helm upgrade chaos-mesh helm/chaos-mesh --namespace=chaos-mesh --version latest',
                    }),
                    '\n',
                  ],
                }),
                ...
                (0, r.jsxs)(n.li, {
                  children: [
                    ...
                    (0, r.jsx)(n.p, {
                      children:
                        'Deploy the target Pod for testing. Skip this step if you have already deployed this Pod:',
                    }),
                    '\n',
                    (0, r.jsx)(n.pre, {
                      children: (0, r.jsx)(n.code, {
                ...
                (0, r.jsxs)(n.li, {
                  children: [
                    '\n',
                    (0, r.jsx)(n.p, { children: 'Create a new YAML file with the following content:' }),
                    '\n',
                    (0, r.jsx)(n.pre, {
                      children: (0, r.jsx)(n.code, {
                ...
                (0, r.jsxs)(n.li, {
                  children: [
                    '\n',
                    (0, r.jsx)(n.p, { children: 'Apply the chaos experiment:' }),
                    '\n',
                    (0, r.jsx)(n.pre, {
                      children: (0, r.jsx)(n.code, {
                        className: 'language-bash',
                        children: 'kubectl apply -f /path/to/helloworld.yaml\n',
                      }),
                    }),
                    '\n',
                  ],
                ...
                (0, r.jsxs)(n.li, {
                  children: [
                    '\n',
                    (0, r.jsx)(n.p, { children: 'Verify the results. You can check several logs:' }),
                    '\n',
                    (0, r.jsxs)(n.ul, {
                      children: [
                        '\n',
                        (0, r.jsx)(n.li, { children: 'Check the logs of Chaos Controller Manager:' }),
                        '\n',
                      ],
                    }),
                    '\n',
                    ...
                    '\n',
                    (0, r.jsxs)(n.ul, {
                      children: ['\n', (0, r.jsx)(n.li, { children: 'Check the logs of Chaos Daemon:' }), '\n'],
                    }),
                    '\n',
                    (0, r.jsx)(n.pre, {
                      children: (0, r.jsx)(n.code, {
                        className: 'language-bash',
                        children: 'kubectl logs chaos-daemon-{pod-post-fix} -n chaos-mesh\n',
                      }),
                    }),
                    '\n',
                    (0, r.jsx)(n.p, { children: 'Example output:' }),
                    ...
                    (0, r.jsxs)(n.p, {
                      children: [
                        'You can see ',
                        (0, r.jsx)(n.code, { children: 'ps aux' }),
                        ' in two separate lines, which are corresponding to two different Pods.',
                      ],
                    }),
                    '\n',
                    (0, r.jsx)(n.admonition, {
            ...
            (0, r.jsxs)(n.p, {
              children: [
                'If you encounter any problems in this process, create an ',
                (0, r.jsx)(n.a, { href: 'https://github.com/pingcap/chaos-mesh/issues', children: 'issue' }),
            ...
            (0, r.jsxs)(n.p, {
              children: [
                'If you are curious about how all of these come into effect, you can read the README files of different ',
                (0, r.jsx)(n.code, { children: 'controllers' }),
                ' in the ',
                (0, r.jsx)(n.code, { children: 'controller' }),
                ' directory to learn their functionalities. For example, ',
                (0, r.jsx)(n.a, {
                  href: 'https://github.com/chaos-mesh/chaos-mesh/blob/master/controllers/README.md',
                  children: 'controllers/README.md',
                }),
                '.',
              ],
            }),
            ...
            (0, r.jsxs)(n.p, {
              children: [
                'Now you are ready to become a Chaos Mesh developer! You are welcome to visit the ',
                (0, r.jsx)(n.a, { href: 'https://github.com/chaos-mesh/chaos-mesh', children: 'Chaos Mesh' }),
                ' repository to find a ',
                (0, r.jsx)(n.a, {
                  href: 'https://github.com/chaos-mesh/chaos-mesh/labels/good%20first%20issue',
    ...
    13137: (e, n, o) => {
      ...
      var s = o(78478),
        ...
        h = o(74848)
      const d = (e) => {
        let { children: n, className: o = 'language-bash' } = e
        const { siteConfig: l } = (0, r.A)(),
        ...
        return (0, h.jsx)(s.A, {
          children: () => {
            ...
            return (0, h.jsx)(a.A, { className: o, children: n.replace('--version latest', s).trim() })
          },
        })
      }
    },
    34661: (e, n, o) => {
      ...
      const c = (e, n) => {
        ...
        if (o === e.baseUrl && s) return 'current' === s ? 'latest' : s
        if (o.includes('/docs/next')) return 'latest'
        const r = n.find((e) => e.isLast),
          t = n.find((e) => o.includes(e.name))
        return t ? t.name : r.name
      }
      const i = (e) => {
        let { children: n, replaced: o = 'latest', isArchive: i = !1, className: h = 'language-bash' } = e
        const { siteConfig: d } = (0, r.A)(),
          { versions: p } = (0, t.P_)('docusaurus-plugin-content-docs')
        return (0, l.jsx)(s.A, {
          children: () => {
            const e = c(d, p),
              s = i
                ...
                ? n
                : n.replace(o, 'v' + e)
            return (0, l.jsx)(a.A, { className: h, children: s })
          },
        })
      }
    },
