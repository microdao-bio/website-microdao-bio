...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [9262],
  {
    14803: (e, n, s) => {
      ...
      const o = JSON.parse(
        '{"id":"manage-user-permissions","title":"Manage User Permissions","description":"This document describes how to manage user permissions in Chaos Mesh, including creating user accounts with different roles, binding permissions to user accounts, managing tokens, and enabling or disabling permission authentication.","source":"@site/versioned_docs/version-2.4.3/manage-user-permissions.md","sourceDirName":".","slug":"/manage-user-permissions","permalink":"/docs/2.4.3/manage-user-permissions","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.4.3/manage-user-permissions.md","tags":[],"version":"2.4.3","frontMatter":{"title":"Manage User Permissions"},"sidebar":"docs","previous":{"title":"Uninstall Chaos Mesh","permalink":"/docs/2.4.3/uninstallation"},"next":{"title":"Configure namespace for Chaos experiments","permalink":"/docs/2.4.3/configure-enabled-namespace"}}'
      )
      var t = s(74848),
        a = s(28453),
        i = s(13137)
