...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [3083],
  {
    5532: (e, s, n) => {
      ...
      const i = JSON.parse(
        '{"id":"simulate-aws-chaos","title":"Simulate AWS Faults","description":"This document describes how to use Chaos Mesh to simulate AWS faults.","source":"@site/versioned_docs/version-2.4.3/simulate-aws-chaos.md","sourceDirName":".","slug":"/simulate-aws-chaos","permalink":"/docs/2.4.3/simulate-aws-chaos","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/versioned_docs/version-2.4.3/simulate-aws-chaos.md","tags":[],"version":"2.4.3","frontMatter":{"title":"Simulate AWS Faults"},"sidebar":"docs","previous":{"title":"Simulate Linux Kernel Faults","permalink":"/docs/2.4.3/simulate-kernel-chaos-on-kubernetes"},"next":{"title":"Simulate Azure Faults","permalink":"/docs/2.4.3/simulate-azure-chaos"}}'
      )
      var t = n(74848),
        c = n(28453)
      ...
      function l(e) {
        ...
        return (0, t.jsxs)(t.Fragment, {
          children: [
            (0, t.jsx)(s.p, { children: 'This document describes how to use Chaos Mesh to simulate AWS faults.' }),
            '\n',
            (0, t.jsx)(s.h2, { id: 'awschaos-introduction', children: 'AWSChaos introduction' }),
            '\n',
            (0, t.jsx)(s.p, {
              children:
            ...
            (0, t.jsxs)(s.ul, {
              children: [
                '\n',
                (0, t.jsxs)(s.li, {
                  children: [(0, t.jsx)(s.strong, { children: 'EC2 Stop' }), ': stops the specified EC2 instance.'],
                }),
                '\n',
                (0, t.jsxs)(s.li, {
                  children: [
                    (0, t.jsx)(s.strong, { children: 'EC2 Restart' }),
                ...
                (0, t.jsxs)(s.li, {
                  children: [
                    (0, t.jsx)(s.strong, { children: 'Detach Volume' }),
            ...
            (0, t.jsxs)(s.ul, {
              children: [
                ...
                (0, t.jsxs)(s.li, {
                  children: [
                    (0, t.jsx)(s.strong, { children: 'aws_access_key_id' }),
                ...
                (0, t.jsxs)(s.li, {
                  children: [
                    (0, t.jsx)(s.strong, { children: 'aws_secret_access_key' }),
                    ' stores the secrete access key to the AWS cluster.',
                  ],
                }),
                '\n',
              ],
              ...
              children: [
                ...
                (0, t.jsxs)(s.ol, {
                  children: [
                    '\n',
                    (0, t.jsxs)(s.li, {
                      children: ['\n', (0, t.jsx)(s.p, { children: 'Chaos Dashboard is installed.' }), '\n'],
                    }),
                    '\n',
                    (0, t.jsxs)(s.li, {
                      children: [
                        ...
                        (0, t.jsxs)(s.p, {
                          children: [
                            ...
                            (0, t.jsx)(s.code, { children: 'kubectl port-forward' }),
                            ':',
                          ],
                        }),
                        '\n',
                        ...
                        (0, t.jsxs)(s.p, {
                          children: [
                            ...
                            (0, t.jsx)(s.a, {
                              ...
                              children: (0, t.jsx)(s.code, { children: 'http://localhost:2333' }),
                            }),
                            ' in your browser.',
                          ],
                        }),
              ...
              children: [
                ...
                (0, t.jsxs)(s.li, {
                  children: [
                    ...
                    '\n',
                    (0, t.jsx)(s.p, {
                      children: (0, t.jsx)(s.img, { alt: 'img', src: n(69377).A + '', width: '959', height: '519' }),
                    }),
                    '\n',
                  ],
                }),
                  ...
                  children: [
                    ...
                    (0, t.jsxs)(s.p, {
                      children: [
                        ...
                        ' area, choose ',
                        (0, t.jsx)(s.strong, { children: 'AWS FAULT' }),
                        ' and select a specific behavior, such as ',
                        (0, t.jsx)(s.strong, { children: 'STOP EC2' }),
                        '.',
                      ],
                    }),
                    '\n',
            ...
            (0, t.jsxs)(s.h3, {
              id: 'an-ec2-stop-configuration-example',
              children: ['An ', (0, t.jsx)(s.code, { children: 'ec2-stop' }), ' configuration example'],
            }),
            '\n',
            (0, t.jsxs)(s.ol, {
              children: [
                  ...
                  children: [
                    ...
                    (0, t.jsxs)(s.p, {
                      children: [
                        ...
                        (0, t.jsx)(s.code, { children: 'awschaos-ec2-stop.yaml' }),
                        ' file, as shown below:',
                      ],
                    }),
                    '\n',
                    ...
                    (0, t.jsxs)(s.p, {
                      children: [
                        ...
                        (0, t.jsx)(s.code, { children: 'ec2-stop' }),
            ...
            (0, t.jsxs)(s.h3, {
              id: 'an-ec2-start-configuration-example',
              children: ['An ', (0, t.jsx)(s.code, { children: 'ec2-start' }), ' configuration example'],
            }),
            '\n',
            (0, t.jsxs)(s.ol, {
              children: [
                ...
                (0, t.jsxs)(s.li, {
                  children: [
                    ...
                    (0, t.jsxs)(s.p, {
                      children: [
                        'Write the experiment configuration to the ',
                        (0, t.jsx)(s.code, { children: 'awchaos-ec2-restot.yaml' }),
                        ' file:',
                      ],
                    }),
                    '\n',
                    ...
                    (0, t.jsxs)(s.p, {
                      children: [
                        ...
                        (0, t.jsx)(s.code, { children: 'ec2-restart' }),
                ...
                (0, t.jsxs)(s.li, {
                  children: [
                    ...
                    (0, t.jsxs)(s.p, {
                      children: [
                        'Write the experiment configuration to the ',
                        (0, t.jsx)(s.code, { children: 'awschaos-detach-volume.yaml' }),
                        ' file:',
                      ],
                    }),
                    '\n',
                    ...
                    (0, t.jsxs)(s.p, {
                      children: [
                        ...
                        (0, t.jsx)(s.code, { children: 'detail-volume' }),
                  ...
                  children: [
                    (0, t.jsxs)(s.tr, {
                      children: [
                        ...
                        (0, t.jsx)(s.td, { children: 'ec2-stop' }),
                    ...
                    (0, t.jsxs)(s.tr, {
                      children: [
                        ...
                        (0, t.jsx)(s.td, { children: 'None' }),
                        (0, t.jsx)(s.td, { children: 'No' }),
                        (0, t.jsx)(s.td, { children: 'cloud-key-secret' }),
                      ],
                    }),
                    (0, t.jsxs)(s.tr, {
                      children: [
                        (0, t.jsx)(s.td, { children: 'awsRegion' }),
                        (0, t.jsx)(s.td, { children: 'string' }),
                        (0, t.jsx)(s.td, { children: 'Specifies the AWS region.' }),
                        (0, t.jsx)(s.td, { children: 'None' }),
                        (0, t.jsx)(s.td, { children: 'Yes' }),
                        (0, t.jsx)(s.td, { children: 'us-east-2' }),
                      ],
                    }),
                    (0, t.jsxs)(s.tr, {
                      children: [
                        (0, t.jsx)(s.td, { children: 'ec2Instance' }),
                        (0, t.jsx)(s.td, { children: 'string' }),
                        (0, t.jsx)(s.td, { children: 'Specifies the ID of the EC2 instance.' }),
                        (0, t.jsx)(s.td, { children: 'None' }),
                        (0, t.jsx)(s.td, { children: 'Yes' }),
                        (0, t.jsx)(s.td, { children: 'your-ec2-instance-id' }),
                      ],
                    }),
                    (0, t.jsxs)(s.tr, {
                      children: [
                        (0, t.jsx)(s.td, { children: 'volumeID' }),
                        (0, t.jsx)(s.td, { children: 'string' }),
                        (0, t.jsxs)(s.td, {
                          children: [
                            ...
                            ' is ',
                            (0, t.jsx)(s.code, { children: 'detach-volume' }),
                            '. This field specifies the EBS volume ID.',
                          ],
                        }),
                        (0, t.jsx)(s.td, { children: 'None' }),
                        (0, t.jsx)(s.td, { children: 'No' }),
                        (0, t.jsx)(s.td, { children: 'your-volume-id' }),
                      ],
                    }),
                    (0, t.jsxs)(s.tr, {
                      children: [
                        (0, t.jsx)(s.td, { children: 'deviceName' }),
                        (0, t.jsx)(s.td, { children: 'string' }),
                        (0, t.jsxs)(s.td, {
                          children: [
                            'This is a required field when the ',
        ...
        return (
          (s = e.disableParentContext
            ? 'function' == typeof e.components
              ...
              : e.components || t
            : r(e.components)),
          i.createElement(c.Provider, { value: s }, e.children)
        )
      }
    },
  },
