...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [4110],
  {
    10461: (e, n, a) => {
      ...
      const s = JSON.parse(
        '{"id":"manage-user-permissions","title":"\u7ba1\u7406\u7528\u6237\u6743\u9650","description":"\u672c\u6587\u6863\u4ecb\u7ecd\u5982\u4f55\u5728 Chaos Mesh \u4e2d\u8fdb\u884c\u7528\u6237\u6743\u9650\u7ba1\u7406\uff0c\u5305\u62ec\u521b\u5efa\u7528\u6237\u5e76\u7ed1\u5b9a\u6743\u9650\u3001\u7ba1\u7406\u4ee4\u724c\u4ee5\u53ca\u5f00\u542f/\u5173\u95ed\u6743\u9650\u9a8c\u8bc1\u529f\u80fd\u3002","source":"@site/i18n/zh/docusaurus-plugin-content-docs/current/manage-user-permissions.md","sourceDirName":".","slug":"/manage-user-permissions","permalink":"/zh/docs/next/manage-user-permissions","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/i18n/zh/docusaurus-plugin-content-docs/current/manage-user-permissions.md","tags":[],"version":"current","frontMatter":{"title":"\u7ba1\u7406\u7528\u6237\u6743\u9650"},"sidebar":"docs","previous":{"title":"\u5378\u8f7d Chaos Mesh","permalink":"/zh/docs/next/uninstallation"},"next":{"title":"\u914d\u7f6e\u5141\u8bb8\u6df7\u6c8c\u5b9e\u9a8c\u7684\u547d\u540d\u7a7a\u95f4","permalink":"/zh/docs/next/configure-enabled-namespace"}}'
      )
      var i = a(74848),
        t = a(28453),
        l = a(13137)
      const d = { title: '\u7ba1\u7406\u7528\u6237\u6743\u9650' },
        r = void 0,
        c = {},
        o = [
          {
      ...
      function A(e) {
        ...
        return (0, i.jsxs)(i.Fragment, {
          children: [
            ...
            (0, i.jsxs)(n.p, {
              children: [
                'Chaos Mesh \u4f7f\u7528 Kubernetes \u539f\u751f\u7684 ',
                (0, i.jsx)(n.a, {
                  href: 'https://kubernetes.io/zh/docs/reference/access-authn-authz/rbac/',
                  children: 'RBAC',
                }),
                ' \u529f\u80fd\u6765\u7ba1\u7406\u7528\u6237\u89d2\u8272\u548c\u6743\u9650\u3002\u7528\u6237\u5728\u521b\u5efa\u3001\u67e5\u770b\u3001\u7ba1\u7406\u6df7\u6c8c\u5b9e\u9a8c\u65f6\uff0c\u9700\u8981\u62e5\u6709 ',
                (0, i.jsx)(n.code, { children: 'chaos-mesh.org' }),
                ' \u8fd9\u4e2a ',
                (0, i.jsx)(n.code, { children: 'apiGroups' }),
                ' \u4e0b\u6df7\u6c8c\u5b9e\u9a8c\u81ea\u5b9a\u4e49\u8d44\u6e90\u7684\u76f8\u5e94\u6743\u9650\u3002',
              ],
            }),
            '\n',
            (0, i.jsx)(n.admonition, {
              ...
              children: (0, i.jsxs)(n.p, {
                children: [
                  '\u4f7f\u7528 Helm \u5b89\u88c5 Chaos Mesh \u65f6\uff0c\u9ed8\u8ba4\u5f00\u542f\u6743\u9650\u9a8c\u8bc1\u529f\u80fd\u3002\u5bf9\u4e8e\u751f\u4ea7\u73af\u5883\u53ca\u5176\u4ed6\u5b89\u5168\u8981\u6c42\u8f83\u9ad8\u7684\u573a\u666f\uff0c\u5efa\u8bae\u4fdd\u6301\u6743\u9650\u9a8c\u8bc1\u529f\u80fd\u5f00\u542f\u3002\u5982\u679c\u53ea\u662f\u60f3\u4f53\u9a8c Chaos Mesh \u7684\u529f\u80fd\uff0c\u5e0c\u671b\u5173\u95ed\u6743\u9650\u9a8c\u8bc1\u4ece\u800c\u5feb\u901f\u521b\u5efa\u6df7\u6c8c\u5b9e\u9a8c\uff0c\u53ef\u4ee5\u76f4\u63a5\u53c2\u9605',
                  (0, i.jsx)(n.a, {
                    href: '#%E5%BC%80%E5%90%AF%E6%88%96%E5%85%B3%E9%97%AD%E6%9D%83%E9%99%90%E9%AA%8C%E8%AF%81%E5%8A%9F%E8%83%BD',
                    children: '\u6743\u9650\u9a8c\u8bc1\u529f\u80fd\u7684\u5f00\u542f\u53ca\u5173\u95ed',
                  }),
                  '\u90e8\u5206\u4e86\u89e3\u5982\u4f55\u5173\u95ed\u6743\u9650\u9a8c\u8bc1\u3002',
                ],
              }),
            ...
            '\n',
            (0, i.jsx)(n.p, {
              children: '\u70b9\u51fb\u540e\uff0c\u5f39\u51fa\u7684\u7a97\u53e3\u5982\u4e0b\u6240\u793a\uff1a',
            }),
            '\n',
            (0, i.jsx)(n.p, {
              children: (0, i.jsx)(n.img, {
                alt: 'Dashboard \u4ee4\u724c\u8f85\u52a9\u751f\u6210\u5668',
                src: a(88892).A + '',
                width: '1572',
                height: '1526',
              }),
            ...
            (0, i.jsxs)(n.ol, {
              children: [
                ...
                (0, i.jsxs)(n.li, {
                  children: [
                    '\n',
                    (0, i.jsx)(n.p, { children: '\u9009\u62e9\u6743\u9650\u8303\u56f4' }),
                    '\n',
                    (0, i.jsxs)(n.p, {
                      children: [
                        '\u5982\u8981\u83b7\u53d6\u6574\u4e2a Kubernetes \u6df7\u6c8c\u5b9e\u9a8c\u7684\u76f8\u5e94\u6743\u9650\uff0c\u52fe\u9009',
                        (0, i.jsx)(n.strong, { children: '\u96c6\u7fa4\u8303\u56f4' }),
                        '\u65b9\u6846\u3002\u5982\u679c\u5728',
                        (0, i.jsx)(n.strong, { children: '\u547d\u540d\u7a7a\u95f4' }),
                        '\u4e0b\u62c9\u9009\u9879\u4e2d\u6307\u5b9a\u4e86 namespace\uff0c\u5219\u53ea\u83b7\u53d6\u8be5 namespace \u4e0b\u7684\u6743\u9650\u3002',
                      ],
                    }),
                    '\n',
                  ],
                ...
                (0, i.jsxs)(n.li, {
                  children: [
                    '\n',
                    (0, i.jsx)(n.p, { children: '\u9009\u62e9\u89d2\u8272' }),
                    '\n',
                    (0, i.jsx)(n.p, {
                      children: '\u76ee\u524d Chaos Mesh \u63d0\u4f9b\u4e86\u4ee5\u4e0b\u89d2\u8272\uff1a',
                    }),
                    '\n',
                    (0, i.jsxs)(n.ul, {
                      children: [
                ...
                (0, i.jsxs)(n.li, {
                  children: [
                    '\n',
                    (0, i.jsx)(n.p, { children: '\u751f\u6210 RBAC \u914d\u7f6e' }),
                    '\n',
                    (0, i.jsxs)(n.p, {
                      children: [
                        '\u5728\u786e\u5b9a\u4e86\u6240\u521b\u5efa\u6743\u9650\u7684\u8303\u56f4\u548c\u89d2\u8272\u540e\uff0cDashboard \u9875\u9762\u4e0a\u4f1a\u663e\u793a\u5bf9\u5e94\u7684 RBAC \u914d\u7f6e\u3002\u4f8b\u5982\uff0c ',
                        (0, i.jsx)(n.code, { children: 'default' }),
                        ' namespace \u4e0b Manager \u89d2\u8272\u7684 RBAC \u914d\u7f6e\u5982\u4e0b\u6240\u793a\uff1a',
                      ],
                    }),
                    '\n',
                    (0, i.jsx)(n.pre, {
                    ...
                    (0, i.jsxs)(n.p, {
                      children: [
                        '\u70b9\u51fb Dashboard \u7a97\u53e3\u4e2d RBAC \u914d\u7f6e\u53f3\u4e0a\u89d2\u7684',
                        (0, i.jsx)(n.strong, { children: '\u590d\u5236' }),
                        '\u5c06 RBAC \u914d\u7f6e\u5185\u5bb9\u590d\u5236\u5230\u526a\u5207\u677f\uff0c\u7136\u540e\u5199\u5165\u5230\u672c\u5730\u6587\u4ef6 ',
                        (0, i.jsx)(n.code, { children: 'rbac.yaml' }),
                        '\u3002',
                      ],
                    }),
                    '\n',
                ...
                (0, i.jsxs)(n.li, {
                  children: [
                    '\n',
                    (0, i.jsx)(n.p, { children: '\u521b\u5efa\u7528\u6237\u5e76\u7ed1\u5b9a\u6743\u9650' }),
                    '\n',
                    (0, i.jsx)(n.p, { children: '\u5728\u7ec8\u7aef\u4e2d\u8fd0\u884c\u4ee5\u4e0b\u547d\u4ee4\uff1a' }),
                    '\n',
                    (0, i.jsx)(n.pre, {
                      children: (0, i.jsx)(n.code, {
                        className: 'language-bash',
                        children: 'kubectl apply -f rbac.yaml\n',
                      }),
                    }),
                    '\n',
                  ],
                ...
                (0, i.jsxs)(n.li, {
                  children: [
                    '\n',
                    (0, i.jsx)(n.p, { children: '\u4f7f\u7528\u521b\u5efa\u7684\u7528\u6237\u767b\u5f55 Chaos Mesh' }),
                    '\n',
                    (0, i.jsxs)(n.p, {
                      children: [
                        '\u70b9\u51fb Dashboard \u4ee4\u724c\u8f85\u52a9\u751f\u6210\u5668\u7a97\u53e3\u4e0a\u7684',
                        (0, i.jsx)(n.strong, { children: '\u5173\u95ed' }),
                        '\uff0c\u8fd4\u56de\u5230\u767b\u5f55\u7a97\u53e3\u3002\u5728',
                        (0, i.jsx)(n.strong, { children: '\u4ee4\u724c' }),
                        '\u8f93\u5165\u6846\u4e2d\u8f93\u5165\u4e0a\u4e00\u6b65\u590d\u5236\u7684 token \u6570\u636e\uff0c\u5e76\u5728',
                        (0, i.jsx)(n.strong, { children: '\u540d\u79f0' }),
                        '\u8f93\u5165\u6846\u4e2d\u7ed9\u8be5\u4ee4\u724c\u8f93\u5165\u4e00\u4e2a\u6709\u610f\u4e49\u7684\u540d\u79f0\uff0c\u5efa\u8bae\u4f7f\u7528\u6743\u9650\u7684\u8303\u56f4\u548c\u89d2\u8272\uff0c\u4f8b\u5982 ',
                        (0, i.jsx)(n.code, { children: 'default-manager' }),
                        '\u3002\u8f93\u5165\u5b8c\u6210\u540e\uff0c\u70b9\u51fb',
                        (0, i.jsx)(n.strong, { children: '\u63d0\u4ea4' }),
                        '\u8fdb\u884c\u767b\u5f55:',
                      ],
                    }),
                    '\n',
            ...
            '\n',
            (0, i.jsx)(n.h3, { id: '\u767b\u51fa\u4ee4\u724c', children: '\u767b\u51fa\u4ee4\u724c' }),
            '\n',
            (0, i.jsxs)(n.p, {
              children: [
                '\u5982\u8981\u4f7f\u7528\u53e6\u4e00\u4e2a\u4ee4\u724c\uff0c\u5728 Dashboard Web \u9875\u9762\u4e2d\u70b9\u51fb',
            ...
            (0, i.jsx)(n.h3, {
              id: '\u5f00\u542f\u6216\u5173\u95ed\u6743\u9650\u9a8c\u8bc1\u529f\u80fd',
              children: '\u5f00\u542f\u6216\u5173\u95ed\u6743\u9650\u9a8c\u8bc1\u529f\u80fd',
            }),
            '\n',
            (0, i.jsxs)(n.p, {
              children: [
                '\u4f7f\u7528 Helm \u5b89\u88c5 Chaos Mesh \u65f6\uff0c\u9ed8\u8ba4\u5f00\u542f\u6743\u9650\u9a8c\u8bc1\u529f\u80fd\u3002\u5bf9\u4e8e\u751f\u4ea7\u73af\u5883\u53ca\u5176\u4ed6\u5b89\u5168\u8981\u6c42\u8f83\u9ad8\u7684\u573a\u666f\uff0c\u5efa\u8bae\u90fd\u4fdd\u6301\u6743\u9650\u9a8c\u8bc1\u529f\u80fd\u5f00\u542f\u3002\u5982\u679c\u53ea\u662f\u60f3\u4f53\u9a8c Chaos Mesh \u7684\u529f\u80fd\uff0c\u5e0c\u671b\u5173\u95ed\u6743\u9650\u9a8c\u8bc1\u4ece\u800c\u5feb\u901f\u521b\u5efa\u6df7\u6c8c\u5b9e\u9a8c\uff0c\u53ef\u4ee5\u5728 Helm \u547d\u4ee4\u4e2d\u8bbe\u7f6e ',
                (0, i.jsx)(n.code, { children: '--set dashboard.securityMode=false' }),
                '\uff0c\u547d\u4ee4\u5982\u4e0b\u6240\u793a\uff1a',
              ],
            }),
            '\n',
            ...
            (0, i.jsxs)(n.p, {
              children: [
                '\u5982\u679c\u60f3\u91cd\u65b0\u5f00\u542f\u6743\u9650\u9a8c\u8bc1\u529f\u80fd\uff0c\u518d\u91cd\u65b0\u8bbe\u7f6e ',
                (0, i.jsx)(n.code, { children: '--set dashboard.securityMode=true' }),
                ' \u5373\u53ef\u3002',
              ],
            }),
          ],
    ...
    13137: (e, n, a) => {
      ...
      const A = (e) => {
        ...
        const { siteConfig: d } = (0, i.A)(),
          { versions: A } = (0, t.P_)('docusaurus-plugin-content-docs')
        return (0, o.jsx)(s.A, {
          children: () => {
            const e = (0, c.t)(d, A),
              s =
            ...
            return (0, o.jsx)(l.A, { className: a, children: n.replace('--version latest', s).trim() })
          },
        })
      }
    },
    34661: (e, n, a) => {
      ...
      const r = (e, n) => {
        ...
        const i = n.find((e) => e.isLast),
          t = n.find((e) => a.includes(e.name))
        return t ? t.name : i.name
      }
      const c = (e) => {
        let { children: n, replaced: a = 'latest', isArchive: c = !1, className: o = 'language-bash' } = e
        const { siteConfig: A } = (0, i.A)(),
          ...
          children: () => {
            const e = r(A, p),
              s = c
                ...
                ? n
                : n.replace(a, 'v' + e)
            return (0, d.jsx)(l.A, { className: o, children: s })
          },
        })
      }
    },
