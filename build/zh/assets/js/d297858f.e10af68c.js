...
;(self.webpackChunkchaos_mesh_website = self.webpackChunkchaos_mesh_website || []).push([
  [5874],
  {
    40326: (e, s, a) => {
      ...
      const t = JSON.parse(
        '{"id":"persistence-dashboard","title":"\u6301\u4e45\u5316 Chaos Dashboard \u6570\u636e","description":"\u672c\u6587\u6863\u4ecb\u7ecd\u5982\u4f55\u6301\u4e45\u5316 Chaos Dashboard \u6570\u636e\u3002","source":"@site/i18n/zh/docusaurus-plugin-content-docs/version-2.5.2/persistence-dashboard.md","sourceDirName":".","slug":"/persistence-dashboard","permalink":"/zh/docs/2.5.2/persistence-dashboard","draft":false,"unlisted":false,"editUrl":"https://github.com/microdao-bio/website-microdao-bio/i18n/zh/docusaurus-plugin-content-docs/version-2.5.2/persistence-dashboard.md","tags":[],"version":"2.5.2","frontMatter":{"title":"\u6301\u4e45\u5316 Chaos Dashboard \u6570\u636e"},"sidebar":"docs","previous":{"title":"\u79bb\u7ebf\u5b89\u88c5","permalink":"/zh/docs/2.5.2/offline-installation"},"next":{"title":"\u5378\u8f7d Chaos Mesh","permalink":"/zh/docs/2.5.2/uninstallation"}}'
      )
      var n = a(74848),
        o = a(28453),
        r = a(13137)
      const i = { title: '\u6301\u4e45\u5316 Chaos Dashboard \u6570\u636e' },
        d = void 0,
        h = {},
        l = [
          { value: 'SQLite\uff08\u9ed8\u8ba4\u5b58\u50a8\uff09', id: 'sqlite\u9ed8\u8ba4\u5b58\u50a8', level: 2 },
        ...
        return (0, n.jsxs)(n.Fragment, {
          children: [
            ...
            (0, n.jsxs)(s.p, {
              children: [
                'Chaos Dashboard \u652f\u6301 ',
                (0, n.jsx)(s.code, { children: 'SQLite' }),
                '\u3001',
                (0, n.jsx)(s.code, { children: 'MySQL' }),
                ' \u548c ',
                (0, n.jsx)(s.code, { children: 'PostgreSQL' }),
                ' \u4f5c\u4e3a\u540e\u7aef\u6570\u636e\u5b58\u50a8\u3002',
              ],
            }),
            '\n',
            (0, n.jsx)(s.h2, {
              id: 'sqlite\u9ed8\u8ba4\u5b58\u50a8',
              children: 'SQLite\uff08\u9ed8\u8ba4\u5b58\u50a8\uff09',
            }),
            '\n',
            (0, n.jsxs)(s.p, {
              children: [
                'Chaos Dashboard \u9ed8\u8ba4\u4f7f\u7528 ',
                (0, n.jsx)(s.code, { children: 'SQLite' }),
                ' \u4f5c\u4e3a\u540e\u7aef\u5b58\u50a8\uff0c\u5e76\u63a8\u8350\u4e3a ',
                (0, n.jsx)(s.code, { children: 'SQLite' }),
                ' \u914d\u7f6e\u5355\u72ec\u7684',
                (0, n.jsx)(s.a, {
                  href: 'https://kubernetes.io/zh/docs/concepts/storage/persistent-volumes/',
                  children: '\u6301\u4e45\u5377 (PV)',
                }),
                ' \u3002\u5982\u9700\u8981\u914d\u7f6e PV\uff0c\u8bf7\u5728\u5b89\u88c5\u7684\u65f6\u5019\u6307\u5b9a ',
                (0, n.jsx)(s.code, { children: 'dashboard.persistentVolume.enabled' }),
                ' \u4e3a ',
                ...
                (0, n.jsx)(s.a, {
                  ...
                  children: (0, n.jsx)(s.code, { children: 'value.yaml' }),
                }),
                ' \u4e2d PV \u76f8\u5173\u7684\u914d\u7f6e\u5982\u4e0b\uff1a',
              ],
            }),
            ...
            (0, n.jsxs)(s.p, {
              children: [
                'Chaos Dashboard \u652f\u6301\u4f7f\u7528 MySQL 5.6 \u6216\u8005\u66f4\u9ad8\u7248\u672c\u4f5c\u4e3a\u540e\u7aef\u5b58\u50a8\u3002\u82e5\u60f3\u4f7f\u7528 MySQL \u4f5c\u4e3a\u540e\u7aef\u5b58\u50a8\uff0c\u53ef\u4ee5\u5728\u5b89\u88c5\u7684\u65f6\u5019\u8bbe\u7f6e ',
                (0, n.jsx)(s.code, { children: 'dashboard.env.DATABASE_DRIVER' }),
                ' \u548c ',
                (0, n.jsx)(s.code, { children: 'dashboard.env.DATABASE_DATASOURCE' }),
                ' \u53c2\u6570\uff0c\u5177\u4f53\u53c2\u6570\u914d\u7f6e\u8bf7\u53c2\u8003[\u5b98\u65b9\u9a71\u52a8\u6587\u6863(',
                (0, n.jsx)(s.a, {
                  href: 'https://github.com/go-sql-driver/mysql#dsn-data-source-name',
                  children: 'https://github.com/go-sql-driver/mysql#dsn-data-source-name',
                }),
                ')',
                ' \u3002',
              ],
            ...
            (0, n.jsxs)(s.p, {
              children: [
                'Chaos Dashboard \u652f\u6301\u4f7f\u7528 PostgreSQL 9.6 \u6216\u8005\u66f4\u9ad8\u7248\u672c\u4f5c\u4e3a\u540e\u7aef\u5b58\u50a8\u3002\u82e5\u60f3\u4f7f\u7528 PostgreSQL \u4f5c\u4e3a\u540e\u7aef\u5b58\u50a8\uff0c\u53ef\u4ee5\u5728\u5b89\u88c5\u7684\u65f6\u5019\u8bbe\u7f6e ',
                (0, n.jsx)(s.code, { children: 'dashboard.env.DATABASE_DRIVER' }),
                ' \u548c ',
                (0, n.jsx)(s.code, { children: 'dashboard.env.DATABASE_DATASOURCE' }),
                ' \u53c2\u6570\uff0c\u5177\u4f53\u53c2\u6570\u914d\u7f6e\u8bf7\u53c2\u8003 ',
            ...
            (0, n.jsxs)(s.p, {
              children: [
                'Chaos Dashboard \u652f\u6301\u914d\u7f6e\u6570\u636e\u7684\u8fc7\u671f\u65f6\u95f4\uff0c\u9ed8\u8ba4 ',
                (0, n.jsx)(s.code, { children: 'Event' }),
                ' \u76f8\u5173\u6570\u636e\u9ed8\u8ba4 ',
                (0, n.jsx)(s.code, { children: '168h' }),
                ' \u8fc7\u671f\uff0c',
                (0, n.jsx)(s.code, { children: 'Experiment' }),
                ' \u76f8\u5173\u6570\u636e\u9ed8\u8ba4 ',
                (0, n.jsx)(s.code, { children: '336h' }),
                ' \u8fc7\u671f\uff0c\u5982\u9700\u8981\u4fee\u6539\uff0c\u53ef\u4ee5\u8bbe\u7f6e ',
                (0, n.jsx)(s.code, { children: 'dashboard.env.TTL_EVENT' }),
                ' \u548c ',
                (0, n.jsx)(s.code, { children: 'dashboard.env.TTL_EXPERIMENT' }),
                ' \u53c2\u6570\uff0c\u5982\uff1a',
              ],
            }),
            '\n',
    ...
    13137: (e, s, a) => {
      ...
      const c = (e) => {
        ...
        const { siteConfig: i } = (0, n.A)(),
          { versions: c } = (0, o.P_)('docusaurus-plugin-content-docs')
        return (0, l.jsx)(t.A, {
          children: () => {
            const e = (0, h.t)(i, c),
              t =
    ...
    34661: (e, s, a) => {
      ...
      const d = (e, s) => {
        ...
        const n = s.find((e) => e.isLast),
          o = s.find((e) => a.includes(e.name))
        return o ? o.name : n.name
      }
      const h = (e) => {
        let { children: s, replaced: a = 'latest', isArchive: h = !1, className: l = 'language-bash' } = e
        const { siteConfig: c } = (0, n.A)(),
